/** Main-process i18n strings for ThreadnoteOffice Slides (dialogs, native menus, export, autosave prompts). */
...
export const tMain = createI18n({
  zh: {
    ...
    errNoModel: '未配置模型名称',
    errGskCli: 'gsk 未登录:请先运行 gsk login 登录 Threadnote 账号',
    errNoDeckAppend:
  ...
  en: {
    ...
    errGskCli: 'gsk not signed in: run gsk login to sign in to your Threadnote account first',
    errNoDeckAppend:
  ...
  ja: {
    ...
    errGskCli:
      'gsk が未サインインです。先に gsk login を実行して Threadnote アカウントにサインインしてください',
    errNoDeckAppend:
  ...
  ko: {
    ...
    errGskCli:
      'gsk가 로그인되어 있지 않습니다. 먼저 gsk login을 실행해 Threadnote 계정에 로그인하세요',
    errNoDeckAppend:
  ...
  fr: {
    ...
    errGskCli:
      "gsk non connecté : exécutez d'abord gsk login pour vous connecter à votre compte Threadnote",
    errNoDeckAppend:
  ...
  de: {
    ...
    errGskCli:
      'gsk nicht angemeldet: Führen Sie zuerst gsk login aus, um sich bei Ihrem Threadnote-Konto anzumelden',
    errNoDeckAppend:
  ...
  es: {
    ...
    errGskCli:
      'gsk sin sesión iniciada: ejecuta primero gsk login para iniciar sesión en tu cuenta de Threadnote',
    errNoDeckAppend:
  ...
  th: {
    ...
    errGskCli: 'gsk ยังไม่ได้เข้าสู่ระบบ: โปรดรัน gsk login เพื่อเข้าสู่ระบบบัญชี Threadnote ก่อน',
    errNoDeckAppend:
  ...
  ru: {
    ...
    errGskCli:
      'gsk не авторизован: сначала выполните gsk login, чтобы войти в учётную запись Threadnote',
    errNoDeckAppend:
  ...
  ar: {
    ...
    errGskCli: 'gsk غير مسجَّل الدخول: شغّل gsk login أولًا لتسجيل الدخول إلى حساب Threadnote',
    errNoDeckAppend:
  ...
  pt: {
    ...
    errGskCli: 'gsk não conectado: execute gsk login primeiro para entrar na sua conta Threadnote',
    errNoDeckAppend:
  ...
  it: {
    ...
    errGskCli:
      "gsk non ha effettuato l'accesso: esegui prima gsk login per accedere al tuo account Threadnote",
    errNoDeckAppend:
  ...
  pl: {
    ...
    errGskCli:
      'gsk nie jest zalogowany: najpierw uruchom gsk login, aby zalogować się na konto Threadnote',
    errNoDeckAppend:
  ...
  cs: {
    ...
    errGskCli: 'gsk není přihlášen: nejprve spusťte gsk login a přihlaste se k účtu Threadnote',
    errNoDeckAppend:
  ...
  nl: {
    ...
    errGskCli:
      'gsk is niet aangemeld: voer eerst gsk login uit om u aan te melden bij uw Threadnote-account',
    errNoDeckAppend:
  ...
  ms: {
    ...
    errGskCli:
      'gsk belum log masuk: jalankan gsk login dahulu untuk log masuk ke akaun Threadnote anda',
    errNoDeckAppend:
  ...
  he: {
    ...
    errGskCli: 'gsk אינו מחובר: הרץ תחילה gsk login כדי להיכנס לחשבון Threadnote שלך',
    errNoDeckAppend:
  ...
  hi: {
    ...
    errGskCli: 'gsk साइन इन नहीं है: पहले gsk login चलाकर अपने Threadnote खाते में साइन इन करें',
    errNoDeckAppend:
  ...
  'zh-TW': {
    ...
    errNoModel: '未設定模型名稱',
    errGskCli: 'gsk 未登入:請先執行 gsk login 登入 Threadnote 帳號',
    errNoDeckAppend:
