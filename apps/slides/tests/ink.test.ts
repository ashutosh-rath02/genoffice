...
import { addPicture, createBlankPptx, openPptx, savePptx } from '@threadnote/pptx-engine'
import { buildRenderSlide, type PictureRenderNode } from '@threadnote/pptx-render'
import {
  decodeInkPayload,
  encodeInkPayload,
  inkNodeHitTest,
