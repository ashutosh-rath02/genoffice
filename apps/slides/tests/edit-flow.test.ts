...
import { openPptx, savePptx, type TextElement } from '@threadnote/pptx-engine'
import { buildRenderSlide, EMU_PER_PX_96, type RenderSlide } from '@threadnote/pptx-render'
import {
  fillToKonva,
  glyphToDraw,
  presetToShapeKind,
