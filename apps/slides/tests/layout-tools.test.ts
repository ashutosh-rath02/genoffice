...
import type { RenderSlide, RenderNode, ShapeRenderNode, PlacedBox } from '@threadnote/pptx-render'
import { runLayoutScript, type LayoutScriptElement } from '../src/renderer/ai/layout-script'
import { auditSlideLayout } from '@threadnote/pipelines/slides/layout-audit'
