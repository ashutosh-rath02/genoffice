...
import type { AiProviderId } from '@threadnote/ai-provider'
...
// hand-traced Threadnote mark, OpenCode's pixel-block favicon glyph and a
...
// (OpenAI, Kimi, Grok, OpenRouter, Requesty, Opper, OpenCode, Threadnote, Custom) use
