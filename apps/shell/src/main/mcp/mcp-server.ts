...
/**
 * Local MCP server for ThreadnoteOffice.
 *
...
export class McpServerService {
  ...
  private createSessionServer(): McpServer {
    const server = new McpServer({ name: 'Threadnote Office', version: this.version })
   ...
   * reads as a ThreadnoteOffice bug. Answers the JSON-RPC parse error itself and
