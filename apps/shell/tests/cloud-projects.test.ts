...
import { gskListPastProjects, type GskPastProjectsPage } from '@threadnote/ai-search'
import {
  cloudStoreOwner,
...
vi.mock('@threadnote/ai-search', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@threadnote/ai-search')>()
