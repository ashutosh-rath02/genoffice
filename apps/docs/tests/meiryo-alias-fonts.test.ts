 ...
 * punctuation ride the bundled ThreadnoteOffice UI Kana JP faces (Noto Sans JP
...
describe('ThreadnoteOffice UI Kana JP (Meiryo UI advances, full height)', () => {
  const regular = readWoff2(join(FONTS, 'ThreadnoteOfficeUIKanaJP-Regular.woff2'))
  const bold = readWoff2(join(FONTS, 'ThreadnoteOfficeUIKanaJP-Bold.woff2'))
