...
const regular = readWoff2(join(FONTS, 'ThreadnoteOfficePoppins-Regular-subset.woff2'))
const bold = readWoff2(join(FONTS, 'ThreadnoteOfficePoppins-Bold-subset.woff2'))

describe('ThreadnoteOffice Poppins (real-metric M365 cloud face)', () => {
