...
import { configureMetricsCache, familyVerticalMetrics } from '@threadnote/font-metrics'
import { createI18n, getUiLang, normalizeLang, setUiLang } from '@threadnote/i18n'
...
import { listCodexModels, shutdownCodexAppServers } from '@threadnote/ai-provider/codex-app-server'
import { listCustomModelsForIpc } from '@threadnote/ai-provider/custom-models'
import {
  generateImageTool,
  testSearchProvider,
  webSearchTool,
...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 Threadnote:请点击下方「登录 Threadnote」完成登录后重试',
    ...
    menuHelp: '帮助',
    menuShortcuts: '键盘快捷键',
    menuDocsHelp: 'ThreadnoteOffice Docs 帮助',
  },
  en: {
    ...
    errGskNotLoggedIn:
      'Not signed in to Threadnote: click “Sign in to Threadnote” below, sign in, then retry',
    ...
    menuDocsHelp: 'ThreadnoteOffice Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    errGskNotLoggedIn:
      'Threadnote にサインインしていません。下の「Threadnote にサインイン」からサインインして再試行してください',
    ...
    menuDocsHelp: 'ThreadnoteOffice Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    errGskNotLoggedIn:
      'Threadnote에 로그인되어 있지 않습니다. 아래 "Threadnote 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
    ...
    menuDocsHelp: 'ThreadnoteOffice Docs 도움말',
  },
  fr: {
    ...
    errGskNotLoggedIn:
      'Non connecté à Threadnote : cliquez sur « Se connecter à Threadnote » ci-dessous, connectez-vous puis réessayez',
    ...
    menuDocsHelp: 'Aide ThreadnoteOffice Docs',
  },
  de: {
    ...
    errGskNotLoggedIn:
      'Nicht bei Threadnote angemeldet: Klicken Sie unten auf „Bei Threadnote anmelden“, melden Sie sich an und versuchen Sie es erneut',
    ...
    menuDocsHelp: 'ThreadnoteOffice Docs-Hilfe',
  },
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en Threadnote: pulsa «Iniciar sesión en Threadnote» abajo, inicia sesión y vuelve a intentarlo',
    ...
    menuDocsHelp: 'Ayuda de ThreadnoteOffice Docs',
  },
  th: {
    ...
    errGskNotLoggedIn:
      'ยังไม่ได้ลงชื่อเข้าใช้ Threadnote: แตะ “ลงชื่อเข้าใช้ Threadnote” ด้านล่าง แล้วลองอีกครั้ง',
    ...
    menuDocsHelp: 'วิธีใช้ ThreadnoteOffice Docs',
  },
  id: {
    ...
    menuDocsHelp: 'Bantuan ThreadnoteOffice Docs',
  },
  ru: {
    ...
    errGskNotLoggedIn:
      'Вы не вошли в Threadnote: нажмите «Войти в Threadnote» ниже, войдите и повторите попытку',
    ...
    menuDocsHelp: 'Справка ThreadnoteOffice Docs',
  },
  ar: {
    ...
    errGskNotLoggedIn:
      'لم تسجّل الدخول إلى Threadnote: انقر على «تسجيل الدخول إلى Threadnote» أدناه ثم أعد المحاولة',
    ...
    menuDocsHelp: 'تعليمات ThreadnoteOffice Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    errGskNotLoggedIn:
      'Não conectado ao Threadnote: clique em “Entrar no Threadnote” abaixo, entre e tente novamente',
    ...
    menuDocsHelp: 'Ajuda do ThreadnoteOffice Docs',
  },
  it: {
    ...
    errGskNotLoggedIn:
      'Accesso a Threadnote non effettuato: fai clic su “Accedi a Threadnote” qui sotto, accedi e riprova',
    ...
    menuDocsHelp: 'Guida di ThreadnoteOffice Docs',
  },
  pl: {
    ...
    errGskNotLoggedIn:
      'Nie zalogowano do Threadnote: kliknij „Zaloguj się do Threadnote” poniżej, zaloguj się i spróbuj ponownie',
    ...
    menuDocsHelp: 'Pomoc ThreadnoteOffice Docs',
  },
  cs: {
    ...
    errGskNotLoggedIn:
      'Nejste přihlášeni do Threadnote: klikněte níže na „Přihlásit se do Threadnote“, přihlaste se a zkuste to znovu',
    ...
    menuDocsHelp: 'Nápověda ThreadnoteOffice Docs',
  },
  nl: {
    ...
    errGskNotLoggedIn:
      'Niet aangemeld bij Threadnote: klik hieronder op “Aanmelden bij Threadnote”, meld u aan en probeer het opnieuw',
  ...
  ms: {
    ...
    errGskNotLoggedIn:
      'Belum log masuk ke Threadnote: klik “Log masuk ke Threadnote” di bawah, kemudian cuba lagi',
  ...
  he: {
    ...
    errGskNotLoggedIn: 'לא מחובר ל-Threadnote: לחץ על "התחבר ל-Threadnote" למטה, התחבר ונסה שוב',
    ...
    menuDocsHelp: 'עזרה של ThreadnoteOffice Docs',
  },
  hi: {
    ...
    errGskNotLoggedIn:
      'Threadnote में साइन इन नहीं है: नीचे “Threadnote में साइन इन करें” पर क्लिक करें, साइन इन करें और फिर से कोशिश करें',
    ...
    menuDocsHelp: 'ThreadnoteOffice Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    errGskNotLoggedIn: '未登入 Threadnote:請點擊下方「登入 Threadnote」完成登入後重試',
    ...
    menuHelp: '說明',
    menuShortcuts: '鍵盤快速鍵',
    menuDocsHelp: 'ThreadnoteOffice Docs 說明',
  },
})
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/ThreadnoteOffice. */
...
const testExportDir = process.env.THREADNOTE_OFFICE_TEST_EXPORT_DIR || null
...
/** office/pdf formats get text extracted via @threadnote/file-parse; images skip extraction and go multimodal (files:read-image) */
...
/** parse an attachment to text via @threadnote/file-parse (docx/pdf/pptx/xlsx/plain text) */
...
// implementations live in @threadnote/ai-provider, shared with apps/sheets.
...
export function registerAiIpc(): void {
  ...
  ipcMain.handle('ai:get-settings', (): AiSettings => {
    ...
    // A saved provider is used when configured; otherwise Codex is selected.
    settings.provider = activeProvider(settings)
    return settings
  })

  // Threadnote account (gsk login state): auth source for AI features; the frontend uses it to prompt login when logged out
  ...
  // provider when one is configured, otherwise the Threadnote CLI behind its login gate.
  ...
  ipcMain.handle('ai:search-test', (_event, input: unknown) => {
    ...
    if (!provider) return { ok: false, error: 'Choose a search provider' }
    return testSearchProvider(provider, String(apiKey ?? ''))
  })

  // Settings UI connection test for a configured media provider.
  ipcMain.handle('ai:media-test', (_event, input: unknown) => {
    ...
    if (!provider || provider === 'none') return { ok: false, error: 'Choose a media provider' }
...
export function registerDocsIpc(): void {
  ...
  ipcMain.handle('docs:altchunk-html-to-docx', async (_event, html: unknown) => {
    ...
    const workDir = await mkdtemp(join(tmpdir(), 'threadnoteoffice-altchunk-'))
  ...
  ipcMain.handle('docs:pick-export-images-target', async (event) => {
    ...
    const pdfPath = join(tmpdir(), `threadnoteoffice-docs-images-${randomUUID()}.pdf`)
...
export function startDocsStandalone(): void {
  ...
  // the installed ThreadnoteOffice Docs is open and forwards its argv there instead.
  ...
  else if (isDev) app.setPath('userData', join(app.getPath('appData'), 'ThreadnoteOffice Docs Dev'))
