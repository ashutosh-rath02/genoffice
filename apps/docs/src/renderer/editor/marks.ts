...
import { symbolGlyph, symbolPuaChar } from '@threadnote/docx-engine'
  ...
  const families = (chain ?? '')
    ...
    .filter(
      (x) =>
        ...
        // internal fonts.css aliases are not user picks: 'ThreadnoteOffice *', the
