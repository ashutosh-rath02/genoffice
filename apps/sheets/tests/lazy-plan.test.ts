...
import { workbookCommandBatchSchema } from '@threadnote/xlsx-gateway/domain/workbook-dsl'
import type { CellState } from '@threadnote/xlsx-gateway/domain/workbook.types'
