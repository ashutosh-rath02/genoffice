...
const MOVE_JUMP_COMMAND_ID = 'threadnoteoffice.command.move-selection-excel-jump'
const EXPAND_JUMP_COMMAND_ID = 'threadnoteoffice.command.expand-selection-excel-jump'
