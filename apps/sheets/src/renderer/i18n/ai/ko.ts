...
export const ko = {
  ...
  aiThreadnoteAccount: 'Threadnote 계정',
  aiAccountChecking: '확인 중…',
  aiLoggedIn: '로그인됨',
  aiLoggedInAs: '로그인됨: {email}',
  aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Threadnote 계정 로그인이 필요합니다)',
  aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
  aiLoginThreadnote: 'Threadnote 로그인',
  aiModel: '모델',
  aiCancel: '취소',
  aiSave: '저장',
