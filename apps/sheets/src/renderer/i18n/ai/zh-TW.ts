...
export const zhTW = {
  ...
  aiThreadnoteAccount: 'Threadnote 帳號',
  aiAccountChecking: '偵測中…',
  aiLoggedIn: '已登入',
  aiLoggedInAs: '已登入：{email}',
  aiNotLoggedIn: '未登入（AI 功能需要登入 Threadnote 帳號）',
  aiWaitingBrowserLogin: '等待瀏覽器登入…',
  aiLoginThreadnote: '登入 Threadnote',
  aiModel: '模型',
  aiCancel: '取消',
  aiSave: '儲存',
  aiUnknownError: '未知錯誤',
