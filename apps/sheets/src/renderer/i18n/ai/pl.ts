...
export const pl = {
  ...
  aiGskLoginBtn: 'Zaloguj się do Threadnote',
  ...
  aiThreadnoteAccount: 'Konto Threadnote',
  aiAccountChecking: 'Sprawdzanie…',
  aiLoggedIn: 'Zalogowano',
  aiLoggedInAs: 'Zalogowano: {email}',
  aiNotLoggedIn: 'Nie zalogowano (funkcje AI wymagają konta Threadnote)',
  aiWaitingBrowserLogin: 'Oczekiwanie na logowanie w przeglądarce…',
  aiLoginThreadnote: 'Zaloguj się do Threadnote',
  aiModel: 'Model',
  aiCancel: 'Anuluj',
  aiSave: 'Zapisz',
