...
export const zh = {
  ...
  aiThreadnoteAccount: 'Threadnote 账号',
  aiAccountChecking: '检测中…',
  aiLoggedIn: '已登录',
  aiLoggedInAs: '已登录：{email}',
  aiNotLoggedIn: '未登录（AI 功能需要登录 Threadnote 账号）',
  aiWaitingBrowserLogin: '等待浏览器登录…',
  aiLoginThreadnote: '登录 Threadnote',
  aiModel: '模型',
  aiCancel: '取消',
  aiSave: '保存',
  aiUnknownError: '未知错误',
