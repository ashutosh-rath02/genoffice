...
export const it = {
  ...
  aiGskLoginBtn: 'Accedi a Threadnote',
  ...
  aiThreadnoteAccount: 'Account Threadnote',
  aiAccountChecking: 'Verifica in corso…',
  aiLoggedIn: 'Accesso effettuato',
  aiLoggedInAs: 'Accesso effettuato: {email}',
  aiNotLoggedIn: 'Accesso non effettuato (le funzioni IA richiedono un account Threadnote)',
  aiWaitingBrowserLogin: "In attesa dell'accesso nel browser…",
  aiLoginThreadnote: 'Accedi a Threadnote',
  aiModel: 'Modello',
  aiCancel: 'Annulla',
  aiSave: 'Salva',
