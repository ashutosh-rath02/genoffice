...
export const he = {
  ...
  aiGskLoginBtn: 'התחבר ל-Threadnote',
  ...
  aiThreadnoteAccount: 'חשבון Threadnote',
  aiAccountChecking: 'בודק…',
  aiLoggedIn: 'מחובר',
  aiLoggedInAs: 'מחובר: {email}',
  aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Threadnote)',
  aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
  aiLoginThreadnote: 'כניסה ל-Threadnote',
  aiModel: 'מודל',
  aiCancel: 'ביטול',
  aiSave: 'שמירה',
  ...
  aiCreditsExhausted: 'קרדיטי AI שלך אזלו',
