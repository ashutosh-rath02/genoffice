...
export const es = {
  ...
  aiThreadnoteAccount: 'Cuenta de Threadnote',
  aiAccountChecking: 'Comprobando…',
  aiLoggedIn: 'Sesión iniciada',
  aiLoggedInAs: 'Sesión iniciada: {email}',
  aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de Threadnote)',
  aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
  aiLoginThreadnote: 'Iniciar sesión en Threadnote',
  aiModel: 'Modelo',
  aiCancel: 'Cancelar',
  aiSave: 'Guardar',
