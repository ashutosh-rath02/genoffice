...
export const ar = {
  ...
  aiThreadnoteAccount: 'حساب Threadnote',
  aiAccountChecking: 'جارٍ التحقق…',
  aiLoggedIn: 'تم تسجيل الدخول',
  aiLoggedInAs: 'تم تسجيل الدخول: {email}',
  aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب Threadnote)',
  aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
  aiLoginThreadnote: 'تسجيل الدخول إلى Threadnote',
  aiModel: 'النموذج',
  aiCancel: 'إلغاء',
  aiSave: 'حفظ',
