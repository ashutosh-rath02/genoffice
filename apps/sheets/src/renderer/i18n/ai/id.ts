...
export const id = {
  ...
  aiGskLoginBtn: 'Masuk ke Threadnote',
  ...
  aiThreadnoteAccount: 'Akun Threadnote',
  aiAccountChecking: 'Memeriksa…',
  aiLoggedIn: 'Sudah masuk',
  aiLoggedInAs: 'Sudah masuk: {email}',
  aiNotLoggedIn: 'Belum masuk (fitur AI memerlukan akun Threadnote)',
  aiWaitingBrowserLogin: 'Menunggu proses masuk di browser…',
  aiLoginThreadnote: 'Masuk ke Threadnote',
  aiModel: 'Model',
  aiCancel: 'Batal',
  aiSave: 'Simpan',
