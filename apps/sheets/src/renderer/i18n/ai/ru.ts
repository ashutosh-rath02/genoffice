...
export const ru = {
  ...
  aiThreadnoteAccount: 'Учётная запись Threadnote',
  aiAccountChecking: 'Проверка…',
  aiLoggedIn: 'Вход выполнен',
  aiLoggedInAs: 'Вход выполнен: {email}',
  aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Threadnote)',
  aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
  aiLoginThreadnote: 'Войти в Threadnote',
  aiModel: 'Модель',
  aiCancel: 'Отмена',
  aiSave: 'Сохранить',
