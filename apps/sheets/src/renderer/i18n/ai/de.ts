...
export const de = {
  ...
  aiGskLoginBtn: 'Bei Threadnote anmelden',
  ...
  aiThreadnoteAccount: 'Threadnote-Konto',
  aiAccountChecking: 'Wird überprüft…',
  aiLoggedIn: 'Angemeldet',
  aiLoggedInAs: 'Angemeldet: {email}',
  aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein Threadnote-Konto)',
  aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
  aiLoginThreadnote: 'Bei Threadnote anmelden',
  aiModel: 'Modell',
  aiCancel: 'Abbrechen',
  aiSave: 'Speichern',
