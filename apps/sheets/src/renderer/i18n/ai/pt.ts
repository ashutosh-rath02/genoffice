...
export const pt = {
  ...
  aiGskLoginBtn: 'Entrar no Threadnote',
  ...
  aiThreadnoteAccount: 'Conta Threadnote',
  aiAccountChecking: 'Verificando…',
  aiLoggedIn: 'Conectado',
  aiLoggedInAs: 'Conectado: {email}',
  aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta Threadnote)',
  aiWaitingBrowserLogin: 'Aguardando login no navegador…',
  aiLoginThreadnote: 'Entrar no Threadnote',
  aiModel: 'Modelo',
  aiCancel: 'Cancelar',
  aiSave: 'Salvar',
