...
const tMain = createI18n({
  ...
  cs: {
    ...
    errGskNotLoggedIn:
      'Nejste přihlášeni ke Threadnote: klikněte níže na „Přihlásit se ke Threadnote“, přihlaste se a zkuste to znovu',
...
export function registerSheetsAiIpc(): void {
  ...
  ipcMain.handle(IPC_CHANNELS.aiGskStatus, () => ({ loggedIn: false }))

  ipcMain.handle(IPC_CHANNELS.aiGskLogin, () => undefined)
