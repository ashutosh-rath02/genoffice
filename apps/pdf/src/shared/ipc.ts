...
import type { AiSettings, AiStreamChunk, AiStreamRequest } from '@threadnote/ai-provider'
...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'ThreadnoteOffice visual signature field: '
...
export type DrawingInput =
  ...
  | {
      ...
      at: [number, number]
      contents: string
      /** Annotation author (/T); omitted → 'ThreadnoteOffice' */
      author?: string
...
/** Editable metadata for a ThreadnoteOffice static form fill embedded as a page image. */
...
/** Extract pages into a new PDF written to the ThreadnoteOffice save dir and opened in a new tab */
 ...
 * ThreadnoteOffice save dir and opened in a new tab */
...
export interface PdfApi {
  ...
  /** Read ThreadnoteOffice static-fill metadata stored inside the PDF. */
