 ...
 * observed on the Threadnote Anthropic route when credits are exhausted (HTTP 200,
 ...
 * (Threadnote: "Your Threadnote credits have been exhausted…") surfaces as a typed
