 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@threadnote/pptx-engine'
...
export function resolveGlow(
  glow: import('@threadnote/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@threadnote/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
