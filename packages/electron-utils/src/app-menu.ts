...
const LABELS: Record<string, Labels> = {
  ...
  fr: {
    ...
    help: 'Aide',
    about: 'À propos de ThreadnoteOffice',
  ...
  es: {
    ...
    help: 'Ayuda',
    about: 'Acerca de Threadnote Office',
  ...
  th: {
    ...
    help: 'วิธีใช้',
    about: 'เกี่ยวกับ ThreadnoteOffice',
  ...
  id: {
    ...
    help: 'Bantuan',
    about: 'Tentang Threadnote Office',
  ...
  pt: {
    ...
    help: 'Ajuda',
    about: 'Sobre o Threadnote Office',
  ...
  it: {
    ...
    help: 'Aiuto',
    about: 'Informazioni su Threadnote Office',
  ...
  pl: {
    ...
    help: 'Pomoc',
    about: 'O programie Threadnote Office',
  ...
  cs: {
    ...
    help: 'Nápověda',
    about: 'O aplikaci Threadnote Office',
  ...
  ms: {
    ...
    help: 'Bantuan',
    about: 'Perihal Threadnote Office',
  ...
  hi: {
    ...
    help: 'सहायता',
    about: 'ThreadnoteOffice के बारे में',
  ...
  return {
    ...
    click: async () => {
      ...
      const { response } = await dialog.showMessageBox({
        ...
        message: 'Threadnote Office',
        detail: `${labels.version} ${version}`,
        buttons: ['OK', labels.copy, ...(canCheck ? [labels.checkUpdates] : [])],
        defaultId: 0,
        cancelId: 0,
      })
      if (response === 1) clipboard.writeText(`Threadnote Office ${version}`)
