...
describe('remoteImageHeaders', () => {
  it('does not send a Referer to remote image hosts', () => {
    expect(remoteImageHeaders('https://8.8.8.8/a.png').Referer).toBeUndefined()
...
describe('fetchRemoteImage', () => {
  it('returns the response on first success', async () => {
    ...
    const resp = await fetchRemoteImage('https://8.8.8.8/a.png', {
      fetchImpl,
      retryDelaysMs: [0, 0],
    })
