...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — het open-source AI-kantoorpakket: Docs, Sheets, Slides, PDF, Markdown en HTML met een ingebouwd AI-paneel" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="Licentie: Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="Nieuwste release"></a>
  ...
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="GitHub-sterren"></a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Website</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Community</b></a> ·
  <a href="../../PRIVACY.md"><b>Privacy</b></a>
</p>

ThreadnoteOffice is een gratis, open-source alternatief voor Microsoft Office voor
...
- **Scriptbaar en klaar voor agents.** De app levert een
  `threadnoteoffice`-opdrachtregel en een skill voor Claude Code, Codex, Cursor,
...
**Haal het hier:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon en Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 en Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs toont een pagina van een jaarverslag in twee kolommen met een cover-afbeelding over de volledige breedte, een KPI-tabel met arcering, koptekst en voettekst, op 80% zoom met het AI-paneel ingeklapt"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: een bedrijfsoverzicht met een bannerafbeelding; de AI heeft de Overview compacter gemaakt en een nieuwe sectie met opsommingstekens toegevoegd, en het paneel biedt een terugdraaifunctie met één klik"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: de AI heeft een Summary-blad toegevoegd met omzet per regio en categorie via SUMIF-formules, plus een kolomdiagram, en meldt 43 toegepaste wijzigingen met een knop om ongedaan te maken"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: gevraagd welke regio de omzet in Q2 aanvoerde, antwoordt de AI Europa met de uitsplitsing per categorie en verwijst als links naar de cellen die het heeft gebruikt, naast het Orders-blad"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Timelapse van ThreadnoteOffice Slides dat de Aurora Home investeerdersdeck genereert: de AI plant het verhaal in het paneel, dia's verschijnen één voor één op het canvas, en de voltooide deck eindigt met de afsluitende vraag" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: de openingsslide van een door AI gegenereerd investeerdersdeck voor Aurora Home op het canvas, met de oorspronkelijke prompt van één regel en de samenvatting van de AI over wat het heeft gebouwd, in het paneel"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: de vormgegeven slotslide van hetzelfde deck van 11 slides, met de miniaturenstrook links en het AI-paneel dat de verhaallijn samenvat"></td>
</tr>
<tr>
<td><b>Eén regel als input</b> — "Create a 10-slide investor pitch deck for Aurora Home…". ThreadnoteOffice bepaalt de verhaallijn, zoekt de cijfers uit en zet elke slide als een echte <code>.pptx</code> op het canvas.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: Edit text mode omkadert elk tekstblok op de pagina voor bewerking op de plek zelf, terwijl het AI-paneel een vraag over het rapport beantwoordt met paginaverwijzingen"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs toont een Word-document dat lokaal is geconverteerd vanuit de kwartaalrapportage-PDF van Helios, geopend in een tweede tab naast de originele PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Timelapse van ThreadnoteOffice HTML dat de Lumen landingspagina van stijl verandert: één Restyle-verzoek in het paneel verandert de donkere Midnight Studio-pagina in de warme Solar Daybreak-versie, terwijl elke sectie en alle inhoud op hun plek blijven" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: een gegenereerde landingspagina voor een zonne-energie bureaulamp in de donkere stijlrichting Midnight Studio, getoond in de live preview met het AI-paneel dat de net gebouwde pagina samenvat"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: een gegenereerde persoonlijke dashboard-UI voor een freelance designer in een warme linnen stijl, met een navigatiebalk links, een begroeting in serif en vier metriekkaarten"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: een gegenereerd datarapport over de EV-markt in broadsheet-stijl, met een kopregel in serif, een hoofdcijfer van 17,3 miljoen en een rij met kerncijfers"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: bij een geselecteerde alinea verschijnt een Ask AI-popover met een getypte instructie en suggestiechips zoals Polish, Make more concise, Expand en Fix grammar, plus de knoppen Send now en Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown toont een document met lanceringsnotities met een tabel, een Mermaid-stroomdiagram en een taaklijst, met de startprompts van het AI-paneel aan de linkerkant"></td>
</tr>
<tr>
...
### 7 · CLI — je coding agent stuurt ThreadnoteOffice aan, op je eigen machine

ThreadnoteOffice levert een `threadnoteoffice`-opdrachtregel en een agent-skill mee.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides toont een deck van acht slides over het zonnestelsel dat een coding agent via de threadnoteoffice-opdrachtregel heeft gebouwd: de openingsslide op het canvas, acht miniaturen links en het AI-paneel geopend" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice-instellingen, pagina Integraties: de threadnoteoffice-skill geïnstalleerd in Claude Code, met Installeren-knoppen naast Codex en Cursor"></td>
</tr>
<tr>
<td><b>Eén prompt aan je agent</b> — "Bouw een deck van acht slides over het zonnestelsel." De agent leest de skill, schrijft een stylesheet, een outline en één paginaspecificatie per slide, genereert de twee foto's met <code>threadnoteoffice image</code> en laat <code>threadnoteoffice slides check</code> alles afwijzen wat overloopt of overlapt, voordat <code>threadnoteoffice create</code> de <code>.pptx</code> samenstelt en <code>slides render</code> per slide een PNG teruggeeft om te bekijken.</td>
<td><b>Eén keer installeren, via Instellingen → Integraties</b> — ThreadnoteOffice toont de coding agents die het op deze computer vindt en schrijft de skill naar elke agent die je kiest. Of download de skill als zip, of voer <code>install the bundled Threadnote Office skill from Settings</code> uit. Commando's en de volledige workflow staan in <a href="#command-line-and-agent-skill">Opdrachtregel en agent-skill</a>.</td>
</tr>
</table>

### 8 · MCP — dezelfde tools via het Model Context Protocol

Elk `threadnoteoffice`-commando is ook een MCP-tool. Claude Code, Claude Desktop,
Cursor en elke andere MCP-client kunnen zelf `threadnoteoffice mcp` starten,
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Time-lapse van Claude Code dat via de threadnoteoffice MCP-server een investeerderspresentatie van acht slides over hernieuwbare energie bouwt: zoekt naar figuren en foto's, controleert elke kandidaat-afbeelding met media, deck_start schrijft de stylesheet en de outline, deck_page voegt telkens één gecontroleerde pagina toe, deck_build stelt de .pptx samen en slides_render geeft een afbeelding van elke slide terug; het afgeronde deck opent daarna in ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides toont het deck Renewable Energy 2026 van acht slides dat Claude Code via de threadnoteoffice MCP-server heeft gebouwd: de openingsslide met een foto van een windmolenpark op het canvas en acht miniaturen links"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice-instellingen, pagina Integraties, MCP-onderdeel: het eenregelige commando claude mcp add voor Claude Code, het JSON-blok voor Cursor, Claude Desktop en andere MCP-clients, en de optie voor de lokale HTTP-server daaronder"></td>
</tr>
<tr>
...
- **Ook Markdown en HTML**, met hetzelfde AI-paneel en lokale export naar
  Word.
- **Scriptbaar.** Een `threadnoteoffice`-opdrachtregel, een agent-skill en een
...
Alles wat de apps met een bestand kunnen, kan de `threadnoteoffice`-opdrachtregel
...
headless. Hij wordt samen met ThreadnoteOffice geïnstalleerd, heeft geen eigen
...
| Hoe                                                         | Wat er gebeurt                                                                                                                                                                                                                   |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Instellingen → Integraties** in de app                    | Toont de agents die op deze computer zijn gevonden; met één klik wordt de skill naar elke agent geschreven die je kiest. Er verschijnt een knop **Bijwerken** wanneer een ThreadnoteOffice-release een nieuwere skill meebrengt. |
...
| `install the bundled Threadnote Office skill from Settings` | Installeert vanuit deze repository in elke agent die skills ondersteunt.                                                                                                                                                         |

Start daarna een nieuwe chat en vraag om een document. De skill leert de
agent wanneer hij naar `threadnoteoffice` moet grijpen, hoe hij een bestand leest
...
onaangeroerd en komt terug met een begeleide foutmelding. `threadnoteoffice help`
...
Binnen `threadnoteoffice` vindt geen enkele modelaanroep plaats: de agent doet het
denkwerk, de CLI het bouwen en controleren, en het resultaat opent in
ThreadnoteOffice of PowerPoint als een gewone `.pptx`.
...
`threadnoteoffice` is hier de CLI die met de app wordt meegeleverd (op macOS
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; het
...
beschikbaar als `threadnoteoffice://guide/*`-resources, dus is er geen skill
...
nog steeds via de provider die in ThreadnoteOffice is ingesteld; al het andere
draait lokaal, en `THREADNOTE_OFFICE_ALLOWED_ROOTS` beperkt elke tool tot de
mappen die je opgeeft.

Het deck over hernieuwbare energie uit de demo hierboven laat zien hoe één
prompt in Claude Code met alleen de `threadnoteoffice` MCP-server aangesloten er
...
ThreadnoteOffice is geconfigureerd.
...
| ------------------------------------ | ------------------------------------------------------- | -------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                               | [Nieuwste `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote)         |
| **macOS** — Intel (x64)              | macOS 11+                                               | [Nieuwste `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)           |
| **Windows** (x64, de meeste pc's)    | Windows 10+, Intel/AMD                                  | [Nieuwste `-x64.exe`-installer](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** op Arm (ARM64)           | Windows 11 op Arm (Snapdragon X en vergelijkbare chips) | [Nieuwste `-arm64.exe`-installer](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 of nieuwer)           | [Nieuwste `.deb`](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+)   | [Nieuwste `.rpm`](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — overige distributies     | x86_64, glibc 2.34+, FUSE 2                             | [Nieuwste `.AppImage`](https://github.com/ashutosh-rath02/threadnote)            |

Alle builds komen van `main`; de macOS- en Windows-installers zijn gesigneerd.
Oudere versies staan op de pagina [Releases](https://github.com/ashutosh-rath02/threadnote).

<details>
<summary><b>Installeren op Linux</b></summary>

De deb installeer je met apt — dat haalt de afhankelijkheden op en voegt
ThreadnoteOffice toe aan het toepassingenmenu:
...
(`cargo` op je PATH); `npm run build -w @threadnote/sheets` compileert die
...
ThreadnoteOffice wordt actief doorontwikkeld en jouw feedback bepaalt mee de
richting.

- **Meld een bug of vraag een functie aan** via
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Doe mee aan de ThreadnoteOffice-groepschat** op
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) om met het team en andere gebruikers te
  praten.
- **Geef de repo een ster** als je iets aan ThreadnoteOffice hebt — dat is de beste
  manier om het project te steunen.

## Veelgestelde vragen

<details>
<summary><b>Is ThreadnoteOffice gratis?</b></summary>

Ja. ThreadnoteOffice is gratis en open source onder de Apache-2.0-licentie — geen
proefperiode, geen betaalde laag voor de apps zelf.

</details>

<details>
<summary><b>Kan ThreadnoteOffice bestanden van Microsoft Word, Excel en PowerPoint openen?</b></summary>

Ja. ThreadnoteOffice opent en bewaart native `.docx`-, `.xlsx`- en `.pptx`-bestanden.
...
<details>
<summary><b>Werkt ThreadnoteOffice offline?</b></summary>
...
<details>
<summary><b>Kan ThreadnoteOffice PDF-bestanden bewerken?</b></summary>
...
<details>
<summary><b>Kan ThreadnoteOffice PDF converteren naar Word, Excel of PowerPoint?</b></summary>
...
Ja. Naast de keyless Genspark-login ondersteunt ThreadnoteOffice je eigen key voor
...
<details>
<summary><b>Kan ThreadnoteOffice HTML converteren naar Word?</b></summary>
...
<details>
<summary><b>Kan ik ThreadnoteOffice aansturen vanuit Claude Code, Codex, Cursor of een script?</b></summary>

Ja. ThreadnoteOffice installeert een `threadnoteoffice`-opdrachtregel die dezelfde engines
...
<details>
<summary><b>Verzamelt ThreadnoteOffice gegevens?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md) voor de volledige lijst van events en
...
ThreadnoteOffice zou niet mogelijk zijn zonder deze open-source projecten:
...
ThreadnoteOffice wordt uitgebracht onder de [Apache License 2.0](../../LICENSE), met
...
De namen en logo's van ThreadnoteOffice en Genspark zijn handelsmerken van Mainfunc,
