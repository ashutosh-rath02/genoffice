...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — la suite Office AI open source: Docs, Sheets, Slides, PDF, Markdown e HTML con un pannello AI integrato" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Sito web</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Community</b></a> ·
  <a href="../../PRIVACY.md"><b>Privacy</b></a>
</p>

ThreadnoteOffice è un'alternativa gratuita e open source a Microsoft Office per
...
- **Scriptabile e pronto per gli agenti.** L'app include una riga di comando
  `threadnoteoffice` e uno skill per Claude Code, Codex, Cursor, Gemini CLI, GitHub
...
**Scaricalo:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon e Intel) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs visualizza una pagina di relazione annuale a due colonne con un'immagine di copertina a piena larghezza, una tabella KPI con sfondo colorato, intestazione e piè di pagina, a zoom 80% con il pannello AI ridotto a icona"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: una panoramica aziendale con un'immagine banner; l'AI ha reso più conciso il paragrafo Overview e inserito una nuova sezione a elenco puntato, e il pannello offre un ripristino a un clic"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: l'AI ha aggiunto un foglio Summary con i ricavi per area e categoria usando formule SUMIF, più un grafico a colonne, e segnala 43 modifiche applicate con un pulsante Annulla"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: alla domanda su quale area ha guidato i ricavi del Q2, l'AI risponde Europa con la suddivisione per categoria e cita come link le celle utilizzate, accanto al foglio Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Time-lapse di ThreadnoteOffice Slides che genera il deck per investitori Aurora Home: l'IA pianifica la narrazione nel pannello, le diapositive appaiono sulla tela una dopo l'altra e il deck finito si conclude con la richiesta finale" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: la slide di copertina di una presentazione per investitori Aurora Home generata dall'AI sulla canvas, con il prompt originale di una riga e il riepilogo dell'AI su cosa ha creato, nel pannello"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: la slide di chiusura progettata della stessa presentazione di 11 slide, con la striscia di miniature a sinistra e il pannello AI che riassume la storyline"></td>
</tr>
<tr>
<td><b>Una riga in ingresso</b> — "Crea una presentazione per investitori di 10 slide per Aurora Home…". ThreadnoteOffice pianifica la storyline, ricerca i numeri e disegna ogni slide sulla canvas come una vera <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: la modalità Modifica testo delimita ogni blocco di testo della pagina per la modifica sul posto, mentre il pannello AI risponde a una domanda sul report con citazioni di pagina"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs mostra un documento Word convertito in locale dal PDF Helios quarterly review, aperto in una seconda scheda accanto al PDF originale"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Time-lapse di ThreadnoteOffice HTML che ristilizza la landing page Lumen: una richiesta di Restyle nel pannello trasforma la pagina scura Midnight Studio nella calda versione Solar Daybreak, mantenendo invariate tutte le sezioni e tutti i testi" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: una landing page generata per una lampada da scrivania solare nella direzione scura Midnight Studio, mostrata nella live preview con il pannello AI che riassume la pagina appena creata"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: un'interfaccia dashboard personale generata per un designer freelance in stile lino caldo, con una barra laterale sinistra, un saluto in serif e quattro card di metriche"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: un report dati generato sul mercato dei veicoli elettrici in stile broadsheet, con una testata serif, una cifra principale di 17,3 milioni e una riga di statistiche"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: un paragrafo selezionato mostra un popover Ask AI con un'istruzione digitata e chip di suggerimento come Migliora, Rendi più conciso, Espandi e Correggi la grammatica, più i pulsanti Invia ora e Aggiungi alla coda"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown visualizza un documento di note di lancio con una tabella, un diagramma di flusso Mermaid e un elenco di attività, con i prompt di partenza del pannello AI a sinistra"></td>
</tr>
<tr>
...
### 7 · CLI — il tuo agente di coding guida ThreadnoteOffice, sul tuo computer

ThreadnoteOffice include una riga di comando `threadnoteoffice` e uno skill per agenti.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides mostra una presentazione di otto slide sul Sistema Solare creata da un agente di coding tramite la riga di comando threadnoteoffice: la slide di copertina sulla canvas, otto miniature a sinistra e il pannello AI aperto" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="Impostazioni di ThreadnoteOffice, pagina Integrazioni: lo skill threadnoteoffice installato in Claude Code, con pulsanti Installa accanto a Codex e Cursor"></td>
</tr>
<tr>
<td><b>Un solo prompt al tuo agente</b> — "Crea una presentazione di otto slide sul Sistema Solare." L'agente legge lo skill, scrive un foglio di stile, una scaletta e una specifica di pagina per ogni slide, genera le due foto con <code>threadnoteoffice image</code> e lascia che <code>threadnoteoffice slides check</code> respinga tutto ciò che sborda o si sovrappone prima che <code>threadnoteoffice create</code> assembli il <code>.pptx</code> e <code>slides render</code> restituisca un PNG per slide da controllare.</td>
<td><b>Installa una volta sola, da Impostazioni → Integrazioni</b> — ThreadnoteOffice elenca gli agenti di coding che trova su questo computer e scrive lo skill in ognuno di quelli che scegli. Oppure scarica lo skill come zip, o esegui <code>install the bundled Threadnote Office skill from Settings</code>. I comandi e il flusso di lavoro completo sono in <a href="#command-line-and-agent-skill">Riga di comando e skill per agenti</a>.</td>
</tr>
</table>

### 8 · MCP — gli stessi strumenti tramite il Model Context Protocol

Ogni comando `threadnoteoffice` è anche uno strumento MCP. Claude Code, Claude
Desktop, Cursor e qualsiasi altro client MCP possono avviare `threadnoteoffice mcp`
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Time-lapse di Claude Code che costruisce una presentazione per investitori di otto slide sulle energie rinnovabili tramite il server MCP di threadnoteoffice: cerca figure e foto, verifica ogni immagine candidata con media, deck_start scrive il foglio di stile e la scaletta, deck_page aggiunge una pagina controllata alla volta, deck_build assembla il .pptx e slides_render restituisce un'immagine di ogni slide; la presentazione finita si apre poi in ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides mostra la presentazione Renewable Energy 2026 di otto slide che Claude Code ha costruito tramite il server MCP di threadnoteoffice: la slide di copertina con una fotografia di un parco eolico sulla canvas e otto miniature a sinistra"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="Impostazioni di ThreadnoteOffice, pagina Integrazioni, parte MCP: il comando in una riga claude mcp add per Claude Code, il blocco JSON per Cursor, Claude Desktop e altri client MCP, e l'opzione del server HTTP locale sotto"></td>
</tr>
<tr>
...
- **Anche Markdown e HTML**, con lo stesso pannello AI e l'esportazione locale
  in Word.
- **Scriptabile.** Una riga di comando `threadnoteoffice`, uno skill per agenti e
...
Tutto ciò che le app possono fare a un file, la riga di comando `threadnoteoffice`
...
motori, senza interfaccia grafica. Si installa insieme a ThreadnoteOffice, non ha
...
| Come                                                        | Cosa succede                                                                                                                                                                                               |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Impostazioni → Integrazioni** nell'app                    | Elenca gli agenti trovati su questo computer; un clic scrive lo skill in ognuno di quelli che scegli. Un pulsante **Aggiorna** compare quando una release di ThreadnoteOffice porta uno skill più recente. |
...
| `install the bundled Threadnote Office skill from Settings` | Installa da questo repository in qualsiasi agente compatibile con gli skill.                                                                                                                               |

Poi apri una nuova chat e chiedi un documento. Lo skill insegna all'agente
quando ricorrere a `threadnoteoffice`, come leggere un file prima di modificarlo e
...
file intatto e restituisce un errore guidato. `threadnoteoffice help` elenca i
...
Nessuna chiamata a un modello avviene dentro `threadnoteoffice`: l'agente pensa, la
CLI costruisce e controlla, e il risultato si apre in ThreadnoteOffice o PowerPoint
...
Qui `threadnoteoffice` è la CLI inclusa nell'app (su macOS
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; il pannello
...
riferimenti delle operazioni come risorse `threadnoteoffice://guide/*`, quindi non
...
`media`) passano comunque dal provider configurato in ThreadnoteOffice; tutto il
resto gira in locale, e `THREADNOTE_OFFICE_ALLOWED_ROOTS` limita ogni strumento
...
collegato solo il server MCP di `threadnoteoffice`:
...
| ------------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)          | macOS 11+                                             | [Ultima versione `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote) |
| **macOS** — Intel (x64)                    | macOS 11+                                             | [Ultima versione `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** (x64, la maggior parte dei PC) | Windows 10+, Intel/AMD                                | [Ultimo installer `-x64.exe`](https://github.com/ashutosh-rath02/threadnote)    |
| **Windows** su Arm (ARM64)                 | Windows 11 su Arm (Snapdragon X e simili)             | [Ultimo installer `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote)  |
| **Linux** — Debian / Ubuntu                | x86_64, glibc 2.34+ (Ubuntu 22.04 o successivo)       | [Ultimo `.deb`](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — Fedora / RHEL / openSUSE       | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Ultimo `.rpm`](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — altre distribuzioni            | x86_64, glibc 2.34+, FUSE 2                           | [Ultimo `.AppImage`](https://github.com/ashutosh-rath02/threadnote)             |
...
Il deb si installa con apt — scarica le dipendenze e aggiunge ThreadnoteOffice al
...
(`cargo` nel PATH); `npm run build -w @threadnote/sheets` la compila
...
ThreadnoteOffice è in sviluppo attivo e il tuo feedback lo plasma.

- **Segnala un bug o richiedi una funzionalità** su
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Unisciti alla chat di gruppo di ThreadnoteOffice** su
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) per parlare con il team e con altri
  utenti.
- **Metti una stella al repo** se ThreadnoteOffice ti è utile — è il modo migliore
  per supportare il progetto.

## FAQ

<details>
<summary><b>ThreadnoteOffice è gratuito?</b></summary>

Sì. ThreadnoteOffice è gratuito e open source sotto licenza Apache-2.0 — nessuna
prova, nessun piano a pagamento per le app in sé.

</details>

<details>
<summary><b>ThreadnoteOffice può aprire file Microsoft Word, Excel e PowerPoint?</b></summary>

Sì. ThreadnoteOffice apre e salva file nativi `.docx`, `.xlsx` e `.pptx`. Il
...
<details>
<summary><b>ThreadnoteOffice funziona offline?</b></summary>
...
<details>
<summary><b>ThreadnoteOffice può modificare file PDF?</b></summary>
...
<details>
<summary><b>ThreadnoteOffice può convertire PDF in Word, Excel o PowerPoint?</b></summary>
...
Sì. Oltre all'accesso Genspark senza chiavi, ThreadnoteOffice supporta l'uso della
...
<details>
<summary><b>ThreadnoteOffice può convertire HTML in Word?</b></summary>
...
<details>
<summary><b>Posso guidare ThreadnoteOffice da Claude Code, Codex, Cursor o da uno script?</b></summary>

Sì. ThreadnoteOffice installa una riga di comando `threadnoteoffice` che esegue gli stessi
...
<details>
<summary><b>ThreadnoteOffice raccoglie dati?</b></summary>
...
Consulta [ThreadnoteOffice Privacy](../../PRIVACY.md) per l'elenco completo di
...
ThreadnoteOffice non sarebbe possibile senza questi progetti open source:
...
ThreadnoteOffice è distribuito con licenza [Apache License 2.0](../../LICENSE), con
...
I nomi e i loghi ThreadnoteOffice e Genspark sono marchi di Mainfunc, Inc. La
