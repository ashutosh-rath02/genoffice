...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — otwarty pakiet biurowy AI: Docs, Sheets, Slides, PDF, Markdown i HTML z wbudowanym panelem AI" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="Licencja: Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="Najnowsze wydanie"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/downloads/ashutosh-rath02/threadnote/total" alt="Liczba pobrań"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="Gwiazdki na GitHubie"></a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Strona internetowa</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Społeczność</b></a> ·
  <a href="../../PRIVACY.md"><b>Prywatność</b></a>
</p>

ThreadnoteOffice to darmowa, otwarta alternatywa dla Microsoft Office na macOS,
...
- **Skryptowalne i gotowe na agentów.** Aplikacja dostarcza wiersz poleceń
  `threadnoteoffice` oraz skill dla agentów Claude Code, Codex, Cursor, Gemini CLI,
...
**Pobierz:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon i Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 i Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs renderuje dwukolumnową stronę raportu rocznego z pełnowymiarowym zdjęciem na okładce, zacienioną tabelą KPI, nagłówkiem i stopką, przy powiększeniu 80% ze zwiniętym panelem AI"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: przegląd firmy z obrazem w formie banera; AI skróciła sekcję Overview i wstawiła nową sekcję z punktami, a panel proponuje jednokrotne przywrócenie"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: AI dodała arkusz Summary z przychodami według regionu i kategorii przy użyciu formuł SUMIF, plus wykres kolumnowy, i zgłasza 43 zastosowane zmiany z przyciskiem Undo"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: na pytanie, który region przewodził w przychodach za Q2, AI odpowiada Europa z podziałem na kategorie i podaje jako klikalne odnośniki komórki, z których skorzystała, obok arkusza Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Timelapse ThreadnoteOffice Slides generującego prezentację inwestorską Aurora Home: AI planuje fabułę w panelu, slajdy pojawiają się na płótnie jeden po drugim, a gotowa prezentacja kończy się finałowym wezwaniem do działania" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: slajd tytułowy wygenerowanej przez AI prezentacji inwestorskiej Aurora Home na płótnie, z oryginalnym jednowierszowym promptem i podsumowaniem AI tego, co zbudowała, w panelu"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: zaprojektowany slajd końcowy tej samej 11-slajdowej prezentacji, z paskiem miniatur po lewej i panelem AI podsumowującym fabułę"></td>
</tr>
<tr>
<td><b>Jedna linijka na wejściu</b> — „Stwórz 10-slajdową prezentację inwestorską dla Aurora Home…”. ThreadnoteOffice planuje fabułę, sprawdza dane liczbowe i tworzy każdy slajd na płótnie jako prawdziwy plik `.pptx`.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: tryb Edit text zaznacza każdy blok tekstu na stronie do edycji w miejscu, a panel AI odpowiada na pytanie o raport z cytowaniem stron"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs wyświetla dokument Word przekonwertowany lokalnie z kwartalnego raportu Helios w formacie PDF, otwarty w drugiej karcie obok oryginalnego PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Timelapse ThreadnoteOffice HTML zmieniającego styl strony docelowej Lumen: jedno żądanie Restyle w panelu zmienia ciemną stronę Midnight Studio w ciepłą wersję Solar Daybreak, podczas gdy każda sekcja i cała treść pozostają na miejscu" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: wygenerowana strona docelowa dla solarnej lampki biurkowej w ciemnym kierunku Midnight Studio, wyświetlana w podglądzie na żywo z panelem AI podsumowującym właśnie zbudowaną stronę"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: wygenerowany interfejs osobistego panelu dla projektanta freelancera w ciepłym, lnianym stylu, z lewym panelem bocznym, szeryfowym powitaniem i czterema kartami metryk"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: wygenerowany raport danych o rynku pojazdów elektrycznych w stylu gazetowym, z szeryfową winietą tytułową, nagłówkową liczbą 17,3 miliona i wierszem statystyk"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: zaznaczony akapit pokazuje wyskakujące okno Ask AI z wpisaną instrukcją i chipami z podpowiedziami, takimi jak Polish, Make more concise, Expand i Fix grammar, a także przyciskami Send now i Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown renderuje dokument z notatkami o wydaniu z tabelą, diagramem przepływu Mermaid i listą zadań, z podpowiedziami startowymi panelu AI po lewej stronie"></td>
</tr>
<tr>
...
### 7 · CLI — Twój agent kodujący steruje ThreadnoteOffice, na Twoim komputerze

ThreadnoteOffice dostarcza wiersz poleceń `threadnoteoffice` oraz skill dla agentów.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides pokazuje ośmioslajdową prezentację o Układzie Słonecznym, którą agent kodujący zbudował przez wiersz poleceń threadnoteoffice: slajd tytułowy na płótnie, osiem miniatur po lewej i otwarty panel AI" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="Ustawienia ThreadnoteOffice, strona Integracje: skill threadnoteoffice zainstalowany w Claude Code, z przyciskami Zainstaluj przy pozycjach Codex i Cursor"></td>
</tr>
<tr>
<td><b>Jeden prompt do Twojego agenta</b> — „Zbuduj ośmioslajdową prezentację o Układzie Słonecznym”. Agent czyta skill, pisze arkusz stylów, konspekt i jedną specyfikację strony na slajd, generuje dwa zdjęcia za pomocą <code>threadnoteoffice image</code> i pozwala, by <code>threadnoteoffice slides check</code> odrzuciło wszystko, co wychodzi poza obszar lub nachodzi na siebie, zanim <code>threadnoteoffice create</code> złoży plik <code>.pptx</code>, a <code>slides render</code> odda po jednym PNG na slajd do obejrzenia.</td>
<td><b>Zainstaluj raz, w Ustawienia → Integracje</b> — ThreadnoteOffice wyświetla agentów kodujących, których znajdzie na tym komputerze, i zapisuje skill w każdym, którego wybierzesz. Możesz też pobrać skill jako zip albo uruchomić <code>install the bundled Threadnote Office skill from Settings</code>. Polecenia i pełny przepływ pracy znajdziesz w sekcji <a href="#command-line-and-agent-skill">Wiersz poleceń i skill dla agentów</a>.</td>
</tr>
</table>

### 8 · MCP — te same narzędzia przez Model Context Protocol

Każde polecenie `threadnoteoffice` jest też narzędziem MCP. Claude Code, Claude
Desktop, Cursor i każdy inny klient MCP mogą samodzielnie uruchomić
`threadnoteoffice mcp`, bez instalowania jakiegokolwiek skilla i bez otwierania
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Poklatkowe nagranie Claude Code budującego ośmioslajdową prezentację inwestorską o energii odnawialnej przez serwer MCP threadnoteoffice: szuka ilustracji i zdjęć, sprawdza każde kandydujące zdjęcie za pomocą media, deck_start zapisuje arkusz stylów i konspekt, deck_page dodaje po jednej sprawdzonej stronie naraz, deck_build składa plik .pptx, a slides_render zwraca obraz każdego slajdu; gotowa prezentacja otwiera się potem w ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides pokazuje ośmioslajdową prezentację Renewable Energy 2026, którą Claude Code zbudował przez serwer MCP threadnoteoffice: slajd tytułowy ze zdjęciem farmy wiatrowej na płótnie i osiem miniatur po lewej"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="Ustawienia ThreadnoteOffice, strona Integracje, część MCP: jednowierszowe polecenie claude mcp add dla Claude Code, blok JSON dla Cursor, Claude Desktop i innych klientów MCP oraz opcja lokalnego serwera HTTP poniżej"></td>
</tr>
<tr>
...
- **Także Markdown i HTML**, z tym samym panelem AI i lokalnym eksportem do
  Word.
- **Skryptowalne.** Wiersz poleceń `threadnoteoffice`, skill dla agentów i serwer
...
Wszystko, co aplikacje potrafią zrobić z plikiem, wiersz poleceń `threadnoteoffice`
...
silnikach, bez interfejsu graficznego. Instaluje się razem z ThreadnoteOffice, nie
...
nietknięty i wraca z pomocnym komunikatem błędu. `threadnoteoffice help` wypisuje
...
Wewnątrz `threadnoteoffice` nie dochodzi do żadnego wywołania modelu: agent myśli,
CLI buduje i sprawdza, a wynik otwiera się w ThreadnoteOffice lub PowerPoint jako
zwyczajny plik `.pptx`.
...
`threadnoteoffice` oznacza tu CLI dostarczane wewnątrz aplikacji (na macOS
...
jako zasoby `threadnoteoffice://guide/*`, więc żaden skill nie jest potrzebny;
...
dostawcę skonfigurowanego w ThreadnoteOffice; wszystko inne działa lokalnie, a
`THREADNOTE_OFFICE_ALLOWED_ROOTS` ogranicza każde narzędzie do folderów, które
wskażesz.
...
| **Windows** na Arm (ARM64)              | Windows 11 na Arm (Snapdragon X i podobne)            | [Najnowszy instalator `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu             | x86_64, glibc 2.34+ (Ubuntu 22.04 lub nowszy)         | [Najnowszy plik `.deb`](https://github.com/ashutosh-rath02/threadnote)             |
| **Linux** — Fedora / RHEL / openSUSE    | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Najnowszy plik `.rpm`](https://github.com/ashutosh-rath02/threadnote)             |
| **Linux** — inne dystrybucje            | x86_64, glibc 2.34+, FUSE 2                           | [Najnowszy plik `.AppImage`](https://github.com/ashutosh-rath02/threadnote)        |
...
Plik deb instaluje się przez apt — ściąga zależności i dodaje ThreadnoteOffice do
menu aplikacji:
...
```bash
sudo dnf install ./threadnoteoffice-<version>.x86_64.rpm     # Fedora / rodzina RHEL
...
sidecara xlsx (`cargo` w PATH); `npm run build -w @threadnote/sheets`
...
ThreadnoteOffice jest w aktywnym rozwoju, a Twoja opinia go kształtuje.

- **Zgłoś błąd lub poproś o funkcję** w
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Przyłącz się do czatu grupowego ThreadnoteOffice** na
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev), aby rozmawiać z zespołem i innymi
  użytkownikami.
- **Oznacz repozytorium gwiazdką**, jeśli ThreadnoteOffice jest dla Ciebie
  przydatne — to najlepszy sposób wsparcia projektu.

## FAQ

<details>
<summary><b>Czy ThreadnoteOffice jest darmowe?</b></summary>

Tak. ThreadnoteOffice jest darmowe i otwarte na licencji Apache-2.0 — bez okresu
próbnego, bez płatnego poziomu dla samych aplikacji.

</details>

<details>
<summary><b>Czy ThreadnoteOffice może otwierać pliki Microsoft Word, Excel i PowerPoint?</b></summary>

Tak. ThreadnoteOffice otwiera i zapisuje natywne pliki `.docx`, `.xlsx` i `.pptx`.
...
<details>
<summary><b>Czy ThreadnoteOffice działa offline?</b></summary>
...
<details>
<summary><b>Czy ThreadnoteOffice może edytować pliki PDF?</b></summary>
...
<details>
<summary><b>Czy ThreadnoteOffice może konwertować PDF do Word, Excel lub PowerPoint?</b></summary>
...
Tak. Oprócz bezkluczowego logowania przez Genspark, ThreadnoteOffice wspiera
...
<details>
<summary><b>Czy ThreadnoteOffice może konwertować HTML do Worda?</b></summary>
...
<details>
<summary><b>Czy mogę sterować ThreadnoteOffice z narzędzi Claude Code, Codex, Cursor albo ze skryptu?</b></summary>

Tak. ThreadnoteOffice instaluje wiersz poleceń `threadnoteoffice`, który uruchamia te same
...
<details>
<summary><b>Czy ThreadnoteOffice zbiera jakieś dane?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md), aby poznać pełny wykaz zdarzeń i
ujawnianych danych.
...
ThreadnoteOffice nie byłoby możliwe bez tych projektów open source:
...
ThreadnoteOffice jest licencjonowane na warunkach [Apache License 2.0](../../LICENSE), z
jednym wyjątkiem: katalog `ee/` jest zarezerwowany dla przyszłych modułów
enterprise i jest objęty [ThreadnoteOffice Enterprise License](../../ee/LICENSE).

Nazwy i logo ThreadnoteOffice oraz Genspark są znakami towarowymi Mainfunc, Inc.
