...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — la suite bureautique IA open source : Docs, Sheets, Slides, PDF, Markdown et HTML avec un panneau IA intégré" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Site web</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Communauté</b></a> ·
  <a href="../../PRIVACY.md"><b>Confidentialité</b></a>
</p>

ThreadnoteOffice est une alternative gratuite et open source à Microsoft Office pour
...
- **Scriptable et prêt pour les agents.** L'application embarque une ligne de
  commande `threadnoteoffice` et un skill pour Claude Code, Codex, Cursor, Gemini
...
**À télécharger :** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon et Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 et Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs affichant une page de rapport annuel à deux colonnes avec une image de couverture pleine largeur, un tableau de KPI ombré, un en-tête et un pied de page, à un zoom de 80 % avec le panneau IA réduit"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs : une présentation d'entreprise avec une image de bannière ; l'IA a resserré la section Overview et inséré une nouvelle section à puces, et le panneau propose une annulation en un clic"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets : l'IA a ajouté une feuille Summary avec le chiffre d'affaires par région et par catégorie à l'aide de formules SUMIF, ainsi qu'un graphique en colonnes, et indique 43 modifications appliquées avec un bouton Annuler"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets : interrogée sur la région ayant généré le plus de chiffre d'affaires au T2, l'IA répond Europe avec la répartition par catégorie et cite les cellules utilisées sous forme de liens, à côté de la feuille Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Time-lapse de ThreadnoteOffice Slides générant le deck investisseurs Aurora Home : l'IA planifie la trame narrative dans le panneau, les diapositives apparaissent une à une sur le canevas, et le deck terminé se conclut sur la demande finale" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides : la diapositive de couverture d'un jeu de diapositives Aurora Home pour investisseurs généré par l'IA sur le canevas, avec le prompt original d'une ligne et le résumé de l'IA de ce qu'elle a construit dans le panneau"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides : la diapositive de clôture, designée, du même jeu de 11 diapositives, avec le bandeau de miniatures à gauche et le panneau IA résumant la trame narrative"></td>
</tr>
<tr>
<td><b>Une ligne en entrée</b> — « Créer un jeu de 10 diapositives pour un pitch investisseur pour Aurora Home… ». ThreadnoteOffice planifie la trame narrative, recherche les chiffres, et rédige chaque diapositive directement sur le canevas sous forme d'un véritable `.pptx`.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF : le mode Modifier le texte délimite chaque bloc de texte de la page pour une modification sur place tandis que le panneau IA répond à une question sur le rapport avec des citations de page"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs affichant un document Word converti localement à partir du PDF de bilan trimestriel Helios, ouvert dans un second onglet à côté du PDF d'origine"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Time-lapse de ThreadnoteOffice HTML relookant la page d'accueil Lumen : une seule requête Restyle dans le panneau transforme la page sombre Midnight Studio en version chaleureuse Solar Daybreak, tandis que chaque section et tout le contenu restent en place" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML : une page de destination générée pour une lampe de bureau solaire dans l'orientation sombre Midnight Studio, affichée dans l'aperçu en direct avec le panneau IA résumant la page qu'elle vient de construire"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML : un tableau de bord personnel généré pour un designer freelance dans un style lin chaleureux, avec un rail latéral gauche, une salutation en serif et quatre cartes de métriques"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML : un rapport de données sur le marché des véhicules électriques généré dans un style broadsheet, avec un bandeau de titre en serif, un chiffre principal de 17,3 millions et une ligne de statistiques"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown : un paragraphe sélectionné affiche une bulle Ask AI avec une instruction saisie et des puces de suggestion telles que Polish, Make more concise, Expand et Fix grammar, ainsi que des boutons Send now et Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown affichant un document de notes de lancement avec un tableau, un diagramme de flux Mermaid et une liste de tâches, avec les prompts de démarrage du panneau IA à gauche"></td>
</tr>
<tr>
...
### 7 · CLI — votre agent de codage pilote ThreadnoteOffice, sur votre machine

ThreadnoteOffice embarque une ligne de commande `threadnoteoffice` et un skill d'agent.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides affichant un deck de huit diapositives sur le Système solaire qu'un agent de codage a construit via la ligne de commande threadnoteoffice : la diapositive de couverture sur le canevas, huit miniatures à gauche et le panneau IA ouvert" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice, page Réglages → Intégrations : le skill threadnoteoffice installé dans Claude Code, avec des boutons Installer à côté de Codex et Cursor"></td>
</tr>
<tr>
<td><b>Un seul prompt à votre agent</b> — « Construis un deck de huit diapositives sur le Système solaire. » L'agent lit le skill, écrit une feuille de style, un plan et une spécification de page par diapositive, génère les deux photos avec <code>threadnoteoffice image</code>, et laisse <code>threadnoteoffice slides check</code> rejeter tout ce qui déborde ou se chevauche avant que <code>threadnoteoffice create</code> n'assemble le <code>.pptx</code> et que <code>slides render</code> ne renvoie un PNG par diapositive à examiner.</td>
<td><b>Installez une fois, depuis Réglages → Intégrations</b> — ThreadnoteOffice liste les agents de codage qu'il trouve sur cet ordinateur et écrit le skill dans chacun de ceux que vous choisissez. Ou téléchargez le skill en zip, ou lancez <code>install the bundled Threadnote Office skill from Settings</code>. Les commandes et le flux de travail complet sont dans <a href="#command-line-and-agent-skill">Ligne de commande et skill d'agent</a>.</td>
</tr>
</table>

### 8 · MCP — les mêmes outils via le Model Context Protocol

Chaque commande `threadnoteoffice` est aussi un outil MCP. Claude Code, Claude
Desktop, Cursor et tout autre client MCP peuvent démarrer `threadnoteoffice mcp`
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Time-lapse de Claude Code construisant un dossier d'investissement de huit diapositives sur les énergies renouvelables via le serveur MCP de threadnoteoffice : recherche des figures et des photos, vérifie chaque image candidate avec media, deck_start écrit la feuille de style et le plan, deck_page ajoute une page vérifiée à la fois, deck_build assemble le .pptx et slides_render renvoie une image de chaque diapositive ; le deck terminé s'ouvre ensuite dans ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides affichant le deck Renewable Energy 2026 de huit diapositives que Claude Code a construit via le serveur MCP de threadnoteoffice : la diapositive de couverture avec une photographie d'un parc éolien sur le canevas et huit miniatures à gauche"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice, page Réglages → Intégrations, partie MCP : la commande claude mcp add en une ligne pour Claude Code, le bloc JSON pour Cursor, Claude Desktop et d'autres clients MCP, et l'option de serveur HTTP local en dessous"></td>
</tr>
<tr>
...
- **Markdown et HTML aussi**, avec le même panneau IA et un export local vers
  Word.
- **Scriptable.** Une ligne de commande `threadnoteoffice`, un skill d'agent et un
...
`threadnoteoffice` peut le faire depuis un terminal : inspecter, convertir, créer,
...
ThreadnoteOffice, n'a besoin d'aucun runtime propre et n'envoie jamais un document
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Réglages → Intégrations** dans l'application              | Liste les agents trouvés sur cet ordinateur ; un clic écrit le skill dans chacun de ceux que vous choisissez. Un bouton **Mettre à jour** apparaît lorsqu'une version de ThreadnoteOffice embarque un skill plus récent. |
...
| `install the bundled Threadnote Office skill from Settings` | Installe depuis ce dépôt dans tout agent compatible avec les skills.                                                                                                                                                     |

Ouvrez ensuite une nouvelle conversation et demandez un document. Le skill
apprend à l'agent quand recourir à `threadnoteoffice`, comment lire un fichier avant
...
fichier intact et renvoie une erreur guidée. `threadnoteoffice help` liste les
...
Aucun appel à un modèle n'a lieu dans `threadnoteoffice` : l'agent réfléchit, la CLI
construit et vérifie, et le résultat s'ouvre dans ThreadnoteOffice ou PowerPoint
...
`threadnoteoffice` désigne ici la CLI fournie dans l'application (sur macOS
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice` ; le panneau
...
d'opérations comme ressources `threadnoteoffice://guide/*`, donc aucun skill n'est
...
passent toujours par le fournisseur configuré dans ThreadnoteOffice ; tout le
reste tourne en local, et `THREADNOTE_OFFICE_ALLOWED_ROOTS` limite chaque outil aux
...
uniquement le serveur MCP `threadnoteoffice` connecté :
...
| ------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Dernier `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote)            |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Dernier `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)              |
| **Windows** (x64, la plupart des PC) | Windows 10+, Intel/AMD                                | [Dernier installateur `-x64.exe`](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** sur Arm (ARM64)          | Windows 11 sur Arm (Snapdragon X et similaires)       | [Dernier installateur `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 ou plus récent)     | [Dernier `.deb`](https://github.com/ashutosh-rath02/threadnote)                    |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Dernier `.rpm`](https://github.com/ashutosh-rath02/threadnote)                    |
| **Linux** — autres distributions     | x86_64, glibc 2.34+, FUSE 2                           | [Dernier `.AppImage`](https://github.com/ashutosh-rath02/threadnote)               |
...
ThreadnoteOffice au menu des applications :
...
```bash
sudo dnf install ./threadnoteoffice-<version>.x86_64.rpm     # Fedora / famille RHEL
...
sidecar xlsx (`cargo` dans le PATH) ; `npm run build -w @threadnote/sheets` le
...
ThreadnoteOffice est en développement actif et vos retours contribuent à le
façonner.

- **Signalez un bug ou proposez une fonctionnalité** sur
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Rejoignez le salon de discussion ThreadnoteOffice** sur
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) pour échanger avec l'équipe et les
  autres utilisateurs.
- **Mettez une étoile au dépôt** si ThreadnoteOffice vous est utile — c'est la
  meilleure façon de soutenir le projet.

## FAQ

<details>
<summary><b>ThreadnoteOffice est-il gratuit ?</b></summary>

Oui. ThreadnoteOffice est gratuit et open source sous licence Apache-2.0 — pas
d'essai, pas de palier payant pour les applications elles-mêmes.

</details>

<details>
<summary><b>ThreadnoteOffice peut-il ouvrir des fichiers Microsoft Word, Excel et PowerPoint ?</b></summary>

Oui. ThreadnoteOffice ouvre et enregistre des fichiers natifs `.docx`, `.xlsx` et
...
<details>
<summary><b>ThreadnoteOffice fonctionne-t-il hors ligne ?</b></summary>
...
<details>
<summary><b>ThreadnoteOffice peut-il modifier des fichiers PDF ?</b></summary>
...
<details>
<summary><b>ThreadnoteOffice peut-il convertir un PDF en Word, Excel ou PowerPoint ?</b></summary>
...
Oui. Outre la connexion Genspark sans clé, ThreadnoteOffice prend en charge
...
<details>
<summary><b>ThreadnoteOffice peut-il convertir du HTML en Word ?</b></summary>
...
<details>
<summary><b>Puis-je piloter ThreadnoteOffice depuis Claude Code, Codex, Cursor ou un script ?</b></summary>

Oui. ThreadnoteOffice installe une ligne de commande `threadnoteoffice` qui exécute les
...
<details>
<summary><b>ThreadnoteOffice collecte-t-il des données ?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md) pour la liste complète des événements
...
ThreadnoteOffice ne serait pas possible sans ces projets open source :
...
ThreadnoteOffice est distribué sous [licence Apache 2.0](../../LICENSE), avec une
exception : le répertoire `ee/` est réservé aux futurs modules d'entreprise
et est couvert par la [ThreadnoteOffice Enterprise License](../../ee/LICENSE).

Les noms et logos ThreadnoteOffice et Genspark sont des marques déposées de
