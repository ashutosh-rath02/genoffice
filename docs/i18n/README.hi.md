...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — ओपन-सोर्स AI ऑफ़िस सूट: बिल्ट-इन AI पैनल के साथ Docs, Sheets, Slides, PDF, Markdown और HTML" width="100%">
    </picture>
  </a>
</p>
...
- **स्क्रिप्ट करने योग्य और एजेंट के लिए तैयार।** ऐप के साथ एक `threadnoteoffice` कमांड लाइन और Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot, OpenCode और Windsurf के लिए एक skill आती है, ताकि कोई कोडिंग एजेंट बिना कोई विंडो खोले आपकी मशीन पर असली Office फ़ाइलें बना, कन्वर्ट, पढ़ और एडिट कर सके।

**पाएँ:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon और Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 और Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs में 80% ज़ूम पर एक टू-कॉलम एन्युअल-रिपोर्ट पेज दिखाया गया है, जिसमें फ़ुल-विड्थ कवर इमेज, शेडेड KPI टेबल, हेडर और फ़ुटर हैं, और AI पैनल संकुचित (collapsed) है"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: बैनर इमेज के साथ एक कंपनी ओवरव्यू; AI ने ओवरव्यू को संक्षिप्त किया और एक नया बुलेटेड सेक्शन जोड़ा, और पैनल एक-क्लिक रोलबैक का विकल्प देता है"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: AI ने SUMIF फ़ॉर्मूला इस्तेमाल करके रीजन और कैटेगरी के हिसाब से रेवेन्यू के साथ एक Summary शीट जोड़ी, साथ ही एक कॉलम चार्ट, और Undo बटन के साथ 43 लागू किए गए बदलावों की रिपोर्ट दी"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: यह पूछने पर कि Q2 रेवेन्यू में कौन सा रीजन आगे रहा, AI Orders शीट के बगल में कैटेगरी ब्रेकडाउन के साथ Europe का जवाब देता है और जिन सेल्स का इस्तेमाल किया, उन्हें लिंक के रूप में साइट करता है"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="ThreadnoteOffice Slides द्वारा Aurora Home इन्वेस्टर डेक बनाने का टाइम-लैप्स: AI पैनल में कहानी की रूपरेखा तय करता है, स्लाइड्स एक के बाद एक कैनवस पर दिखती हैं, और तैयार डेक closing ask पर खत्म होता है" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: कैनवस पर AI-जनरेटेड Aurora Home इन्वेस्टर डेक की कवर स्लाइड, साथ में मूल एक-लाइन प्रॉम्प्ट और पैनल में AI का यह सारांश कि उसने क्या बनाया"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: उसी 11-स्लाइड डेक की डिज़ाइन की गई क्लोज़िंग स्लाइड, बाईं ओर थंबनेल स्ट्रिप और स्टोरीलाइन का सारांश देता AI पैनल"></td>
</tr>
<tr>
<td><b>एक लाइन डालें</b> — "Aurora Home के लिए 10-स्लाइड का इन्वेस्टर पिच डेक बनाएँ…"। ThreadnoteOffice स्टोरीलाइन प्लान करता है, नंबरों पर रिसर्च करता है, और हर स्लाइड को असली <code>.pptx</code> के रूप में कैनवस पर तैयार करता है।</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: Edit text मोड इन-प्लेस एडिटिंग के लिए पेज के हर टेक्स्ट ब्लॉक की आउटलाइन दिखाता है, जबकि AI पैनल पेज साइटेशन के साथ रिपोर्ट से जुड़े सवाल का जवाब देता है"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs में Helios क्वार्टरली रिव्यू PDF से लोकल रूप से कन्वर्ट किया गया Word डॉक्यूमेंट दिख रहा है, जो मूल PDF के बगल में दूसरे टैब में खुला है"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="ThreadnoteOffice HTML द्वारा Lumen लैंडिंग पेज को दोबारा स्टाइल करने का टाइम-लैप्स: पैनल में एक Restyle रिक्वेस्ट डार्क Midnight Studio पेज को गर्म Solar Daybreak वर्शन में बदल देती है, जबकि हर सेक्शन और सारा कॉन्टेंट अपनी जगह पर बना रहता है" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: डार्क Midnight Studio डायरेक्शन में एक सोलर डेस्क लैंप के लिए जनरेट किया गया लैंडिंग पेज, लाइव प्रीव्यू में दिखाया गया, साथ में AI पैनल जो अभी बनाए गए पेज का सारांश दे रहा है"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: एक फ़्रीलांस डिज़ाइनर के लिए गर्म लिनन स्टाइल में जनरेट किया गया पर्सनल डैशबोर्ड UI, जिसमें एक लेफ़्ट रेल, सेरिफ़ ग्रीटिंग और चार मेट्रिक कार्ड हैं"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: ब्रॉडशीट स्टाइल में जनरेट की गई EV-मार्केट डेटा रिपोर्ट, जिसमें एक सेरिफ़ मास्टहेड, 17.3 मिलियन की हेडलाइन फ़िगर और एक स्टैट रो है"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: चुने गए पैराग्राफ़ पर एक Ask AI पॉपओवर दिखता है, जिसमें टाइप किया हुआ इंस्ट्रक्शन और Polish, Make more concise, Expand व Fix grammar जैसे सजेशन चिप्स हैं, साथ ही Send now और Add to queue बटन हैं"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown एक लॉन्च-नोट्स डॉक्यूमेंट रेंडर कर रहा है जिसमें एक टेबल, एक Mermaid फ़्लोचार्ट और एक टास्क लिस्ट है, और बाईं ओर AI पैनल के स्टार्टर प्रॉम्प्ट हैं"></td>
</tr>
<tr>
...
### 7 · CLI — आपका कोडिंग एजेंट ThreadnoteOffice चलाता है, आपकी मशीन पर

ThreadnoteOffice के साथ एक `threadnoteoffice` कमांड लाइन और एक एजेंट skill आती है। skill इंस्टॉल करें, और Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot, OpenCode या Windsurf उन्हीं इंजनों के ज़रिए, जिन पर ऐप्स चलते हैं, बिना कोई विंडो खोले असली Office फ़ाइलें बना, कन्वर्ट, पढ़ और एडिट कर सकते हैं।

<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides में सोलर सिस्टम पर आठ स्लाइड का एक डेक दिखाया गया है, जिसे एक कोडिंग एजेंट ने threadnoteoffice कमांड लाइन के ज़रिए बनाया: कैनवस पर कवर स्लाइड, बाईं ओर आठ थंबनेल और AI पैनल खुला हुआ" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice Settings का Integrations पेज: threadnoteoffice skill Claude Code में इंस्टॉल है, और Codex व Cursor के बगल में Install बटन हैं"></td>
</tr>
<tr>
<td><b>अपने एजेंट को एक प्रॉम्प्ट</b> — "सोलर सिस्टम पर आठ स्लाइड का डेक बनाएँ।" एजेंट skill पढ़ता है, एक स्टाइल शीट, एक आउटलाइन और हर स्लाइड के लिए एक पेज स्पेक लिखता है, <code>threadnoteoffice image</code> से दो फ़ोटो जनरेट करता है, और <code>threadnoteoffice slides check</code> को ओवरफ़्लो या ओवरलैप करने वाली हर चीज़ रिजेक्ट करने देता है; इसके बाद <code>threadnoteoffice create</code> <code>.pptx</code> असेंबल करता है और <code>slides render</code> देखने के लिए हर स्लाइड का एक PNG वापस देता है।</td>
<td><b>एक बार इंस्टॉल करें, सेटिंग्स → इंटीग्रेशन से</b> — ThreadnoteOffice इस कंप्यूटर पर मिले कोडिंग एजेंट्स की सूची दिखाता है और आपके चुने हुए हर एजेंट में skill लिख देता है। या skill को zip के रूप में डाउनलोड करें, या <code>install the bundled Threadnote Office skill from Settings</code> चलाएँ। कमांड और पूरा वर्कफ़्लो <a href="#command-line-and-agent-skill">कमांड लाइन और एजेंट skill</a> में हैं।</td>
</tr>
</table>

### 8 · MCP — Model Context Protocol पर वही टूल्स

हर `threadnoteoffice` कमांड एक MCP टूल भी है। Claude Code, Claude Desktop,
Cursor और कोई भी अन्य MCP क्लाइंट खुद `threadnoteoffice mcp` शुरू कर सकते हैं, न कोई
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Claude Code का threadnoteoffice MCP सर्वर के ज़रिए आठ स्लाइड के रिन्यूएबल एनर्जी इन्वेस्टर ब्रीफ़िंग डेक बनाने का टाइम-लैप्स: यह search से आँकड़े और तस्वीरें ढूँढ़ता है, media से हर उम्मीदवार तस्वीर को जाँचता है, deck_start स्टाइल शीट और आउटलाइन लिखता है, deck_page एक बार में एक जाँची गई पेज जोड़ता है, deck_build .pptx असेंबल करता है और slides_render हर स्लाइड की तस्वीर वापस देता है; बना हुआ डेक फिर ThreadnoteOffice Slides में खुलता है" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides में आठ स्लाइड का रिन्यूएबल एनर्जी 2026 डेक दिखाया गया है जिसे Claude Code ने threadnoteoffice MCP सर्वर के ज़रिए बनाया: कैनवस पर विंड फ़ार्म की तस्वीर वाली कवर स्लाइड और बाईं ओर आठ थंबनेल"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice Settings का Integrations पेज, MCP हिस्सा: Claude Code के लिए एक-लाइन का claude mcp add कमांड, Cursor, Claude Desktop और दूसरे MCP क्लाइंट्स के लिए JSON ब्लॉक, और नीचे लोकल HTTP सर्वर का विकल्प"></td>
</tr>
<tr>
...
- **स्क्रिप्ट करने योग्य।** एक `threadnoteoffice` कमांड लाइन, एक एजेंट skill और एक
...
ऐप्स किसी फ़ाइल के साथ जो कुछ कर सकते हैं, वह सब `threadnoteoffice` कमांड लाइन टर्मिनल से
कर सकती है: Word, Excel, PowerPoint, PDF, Markdown और HTML को उन्हीं इंजनों पर,
हेडलेस, इंस्पेक्ट, कन्वर्ट, क्रिएट, रीड और एडिट करना। यह ThreadnoteOffice के साथ इंस्टॉल
...
| कैसे                                                        | क्या होता है                                                                                                                                                                                       |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ऐप में **सेटिंग्स → इंटीग्रेशन**                            | इस कंप्यूटर पर मिले एजेंट्स की सूची दिखाता है; एक क्लिक में आपके चुने हुए हर एजेंट में skill लिख देता है। जब किसी ThreadnoteOffice रिलीज़ में नई skill आती है, तो एक **Update** बटन दिखाई देता है। |
...
| `install the bundled Threadnote Office skill from Settings` | इस रिपॉज़िटरी से किसी भी skills-compatible एजेंट में इंस्टॉल करता है।                                                                                                                              |

फिर एक नई चैट शुरू करें और कोई डॉक्यूमेंट माँगें। skill एजेंट को सिखाती है कि
`threadnoteoffice` का सहारा कब लेना है, एडिट करने से पहले फ़ाइल कैसे पढ़नी है, और अपना
...
एक गाइडेड एरर के साथ वापस आता है। `threadnoteoffice help` मौजूदा कमांड सरफ़ेस की सूची
...
`threadnoteoffice` के भीतर कोई मॉडल कॉल नहीं होती: सोचने का काम एजेंट करता है, बनाने
और जाँचने का काम CLI करती है, और नतीजा ThreadnoteOffice या PowerPoint में एक सामान्य
...
| तरीका                                       | क्या है                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A · `threadnoteoffice mcp`** (सुझाया गया) | एक stdio सर्वर जिसे असिस्टेंट खुद शुरू करता है; ThreadnoteOffice का खुला होना ज़रूरी नहीं। हर कमांड के लिए एक टूल (`info`, `convert`, `create_docx`, `create_xlsx`, `create_pptx`, `create_pdf`, `docs_read` / `docs_apply` / `docs_check`, `sheet_*`, `slides_*`, `render`, `guide`, `search`, `image`, `media`, `open`) है, साथ ही चरणबद्ध डेक फ़्लो `deck_start` → `deck_page` → `deck_build` → `deck_replace`। Ops, spec और Markdown सब इनलाइन पास होते हैं, इसलिए बिना फ़ाइल सिस्टम वाला क्लाइंट भी काम करता है। |
| **B · लोकल HTTP सर्वर**                     | ThreadnoteOffice ऐप के भीतर `http://127.0.0.1:3093/mcp` पर चलता है (Streamable HTTP, लेगेसी SSE के साथ)। इसके टूल्स एक दिखने वाले Word एडिटर टैब को चलाते हैं: `create_session`, `insert_content`, `replace_blocks`, `apply_ops`, `read_document`, `save_session`, और आप डॉक्यूमेंट को आकार लेते देख सकते हैं। डिफ़ॉल्ट रूप से बंद; उसी सेटिंग्स पैनल में चालू करें।                                                                                                                                                  |
...
यहाँ `threadnoteoffice` वही CLI है जो ऐप के भीतर आती है (macOS पर
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; सेटिंग्स
पैनल आपकी इंस्टॉल की सटीक path दिखाता है)। सर्वर अपने साथ अपनी वर्कफ़्लो
इंस्ट्रक्शंस लेकर आता है और ऑप रेफ़रेंस को `threadnoteoffice://guide/*` resources
...
(`search`, `image`, `media`) अब भी ThreadnoteOffice में कॉन्फ़िगर किए गए प्रोवाइडर
से होकर जाते हैं; बाक़ी सब कुछ लोकल चलता है, और `THREADNOTE_OFFICE_ALLOWED_ROOTS`
हर टूल को आपके बताए फ़ोल्डर्स तक सीमित रखता है।

ऊपर दिए गए डेमो का रिन्यूएबल एनर्जी डेक यही है कि सिर्फ़ `threadnoteoffice` MCP
...
अड़तीस कॉल्स, लगभग तेरह मिनट, और असिस्टेंट ने कभी टर्मिनल को छुआ तक नहीं: आँकड़े, तस्वीरें, गाइड्स, चेक्स और रेंडर्स सब MCP टूल रिज़ल्ट्स के रूप में आए-गए। मशीन से बाहर सिर्फ़ `search` और `media` गए, ThreadnoteOffice में सेट किए गए प्रोवाइडर तक।
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------ |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [नवीनतम `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote)         |
| **macOS** — Intel (x64)              | macOS 11+                                             | [नवीनतम `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)           |
| **Windows** (x64, ज़्यादातर PC)      | Windows 10+, Intel/AMD                                | [नवीनतम `-x64.exe` installer](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** Arm पर (ARM64)           | Windows 11 on Arm (Snapdragon X और समान)              | [नवीनतम `-arm64.exe` installer](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 या नया)             | [नवीनतम `.deb`](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [नवीनतम `.rpm`](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — अन्य डिस्ट्रीब्यूशन      | x86_64, glibc 2.34+, FUSE 2                           | [नवीनतम `.AppImage`](https://github.com/ashutosh-rath02/threadnote)            |

सभी बिल्ड `main` से बनते हैं; macOS और Windows इंस्टॉलर साइन किए हुए हैं।
पुराने वर्शन [Releases](https://github.com/ashutosh-rath02/threadnote) पेज पर मौजूद हैं।

<details>
<summary><b>Linux पर इंस्टॉल करना</b></summary>

deb, apt के साथ इंस्टॉल होता है — यह डिपेंडेंसीज़ खींच लेता है और ThreadnoteOffice को applications मेन्यू में जोड़ देता है:
...
(`cargo` PATH में होना चाहिए); `npm run build -w @threadnote/sheets` इसे
...
ThreadnoteOffice पर सक्रिय रूप से काम चल रहा है, और आपका फ़ीडबैक इसे आकार देता है।

- [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues) में
  **बग रिपोर्ट करें या फ़ीचर रिक्वेस्ट करें**।
- टीम और दूसरे यूज़र्स से बात करने के लिए
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) पर **ThreadnoteOffice ग्रुप चैट जॉइन करें**।
- अगर ThreadnoteOffice आपके लिए उपयोगी है तो **रीपो को स्टार करें** — प्रोजेक्ट को
  सपोर्ट करने का यह सबसे अच्छा तरीका है।

## FAQ

<details>
<summary><b>क्या ThreadnoteOffice फ़्री है?</b></summary>

हाँ। ThreadnoteOffice, Apache-2.0 लाइसेंस के तहत फ़्री और ओपन-सोर्स है — कोई ट्रायल
नहीं, ऐप्स के लिए खुद कोई पेड टियर नहीं।

</details>

<details>
<summary><b>क्या ThreadnoteOffice Microsoft Word, Excel और PowerPoint फ़ाइलें खोल सकता है?</b></summary>

हाँ। ThreadnoteOffice नेटिव `.docx`, `.xlsx` और `.pptx` फ़ाइलें खोलता और सेव करता है।
...
<details>
<summary><b>क्या ThreadnoteOffice ऑफ़लाइन काम करता है?</b></summary>
...
<details>
<summary><b>क्या ThreadnoteOffice PDF फ़ाइलें एडिट कर सकता है?</b></summary>
...
<details>
<summary><b>क्या ThreadnoteOffice PDF को Word, Excel या PowerPoint में कन्वर्ट कर सकता है?</b></summary>
...
हाँ। बिना-key वाले Genspark साइन-इन के अलावा, ThreadnoteOffice Claude, OpenAI,
...
<details>
<summary><b>क्या ThreadnoteOffice HTML को Word में कन्वर्ट कर सकता है?</b></summary>
...
<details>
<summary><b>क्या मैं Claude Code, Codex, Cursor या किसी स्क्रिप्ट से ThreadnoteOffice चला सकता हूँ?</b></summary>

हाँ। ThreadnoteOffice एक `threadnoteoffice` कमांड लाइन इंस्टॉल करता है जो उन्हीं इंजनों को
...
<details>
<summary><b>क्या ThreadnoteOffice कोई डेटा कलेक्ट करता है?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md) देखें।
...
इन ओपन-सोर्स प्रोजेक्ट्स के बिना ThreadnoteOffice संभव नहीं होता:
...
ThreadnoteOffice को [Apache License 2.0](../../LICENSE) के तहत लाइसेंस किया गया
है, एक अपवाद के साथ: `ee/` डायरेक्टरी भविष्य के एंटरप्राइज़ मॉड्यूल्स के लिए
रिज़र्व है और [ThreadnoteOffice Enterprise License](../../ee/LICENSE) के तहत आती है।

ThreadnoteOffice और Genspark के नाम व लोगो, Mainfunc, Inc. के ट्रेडमार्क हैं।
