...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — свободный AI-офисный пакет с открытым исходным кодом: Docs, Sheets, Slides, PDF, Markdown и HTML со встроенной AI-панелью" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="Лицензия: Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="Последний релиз"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/downloads/ashutosh-rath02/threadnote/total" alt="Загрузки"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="Звёзды на GitHub"></a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Сайт</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Сообщество</b></a> ·
  <a href="../../PRIVACY.md"><b>Конфиденциальность</b></a>
</p>

ThreadnoteOffice — бесплатная альтернатива Microsoft Office с открытым исходным
...
- **Скриптуемость и готовность к агентам.** В комплекте с приложением идёт
  командная строка `threadnoteoffice` и скилл для Claude Code, Codex, Cursor,
...
**Скачать:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon и Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 и Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs отображает страницу годового отчёта в две колонки с полноширинным изображением на обложке, затемнённой таблицей KPI, верхним и нижним колонтитулами при масштабе 80% и свёрнутой AI-панелью"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: обзор компании с изображением-баннером; AI сократил раздел Overview и добавил новый раздел со списком, а панель предлагает откат одним щелчком"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: AI добавил лист Summary с доходом по регионам и категориям на формулах SUMIF, плюс столбчатую диаграмму, и сообщает о 43 применённых изменениях с кнопкой отмены"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: на вопрос о том, какой регион лидировал по доходу во втором квартале, AI отвечает «Европа» с разбивкой по категориям и указывает точные ячейки как ссылки-цитаты, рядом с листом Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Таймлапс создания презентации ThreadnoteOffice Slides для инвесторской колоды Aurora Home: ИИ планирует сюжет в панели, слайды появляются на холсте один за другим, а готовая презентация завершается финальным призывом к действию" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: титульный слайд презентации для инвесторов Aurora Home, созданной AI, на холсте, с исходным однострочным промптом и резюме AI о том, что было построено, на панели"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: оформленный финальный слайд той же презентации из 11 слайдов, с полосой миниатюр слева и AI-панелью, подытоживающей сюжетную линию"></td>
</tr>
<tr>
<td><b>Одна строка на входе</b> — «Создай презентацию для инвесторов из 10 слайдов для Aurora Home…». ThreadnoteOffice выстраивает сюжетную линию, собирает цифры и создаёт каждый слайд прямо на холсте как настоящий файл <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: режим редактирования текста обводит каждый текстовый блок на странице для редактирования на месте, а AI-панель отвечает на вопрос об отчёте со ссылками на страницы"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs показывает документ Word, конвертированный локально из квартального отчёта Helios в формате PDF, открытый во второй вкладке рядом с исходным PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Таймлапс изменения стиля ThreadnoteOffice HTML для лендинга Lumen: один запрос Restyle в панели превращает тёмную страницу Midnight Studio в тёплую версию Solar Daybreak, при этом все разделы и весь текст остаются на месте" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: сгенерированный лендинг для настольной лампы на солнечных батареях в тёмном направлении Midnight Studio, показанный в живом предпросмотре, с AI-панелью, резюмирующей только что созданную страницу"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: сгенерированный интерфейс личного дашборда для дизайнера-фрилансера в тёплом «льняном» стиле, с боковой панелью, серифным приветствием и четырьмя карточками показателей"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: сгенерированный отчёт о рынке электромобилей в стиле широкоформатной газеты, с серифной шапкой, заголовной цифрой 17,3 миллиона и строкой статистики"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: у выделенного абзаца всплывает окно Ask AI с введённой инструкцией и чипами-подсказками, такими как «Отполировать», «Сделать короче», «Развернуть» и «Исправить грамматику», а также кнопками «Отправить сейчас» и «Добавить в очередь»"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown отображает документ с заметками о релизе, содержащий таблицу, блок-схему Mermaid и список задач, со стартовыми промптами AI-панели слева"></td>
</tr>
<tr>
...
### 7 · CLI — ваш кодинг-агент управляет ThreadnoteOffice на вашем компьютере

В ThreadnoteOffice входит командная строка `threadnoteoffice` и агентный скилл. Установите
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides показывает презентацию о Солнечной системе из восьми слайдов, которую кодинг-агент собрал через командную строку threadnoteoffice: титульный слайд на холсте, восемь миниатюр слева и открытая AI-панель" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice Settings, страница Integrations: скилл threadnoteoffice установлен в Claude Code, рядом с Codex и Cursor — кнопки Install"></td>
</tr>
<tr>
<td><b>Один промпт вашему агенту</b> — «Сделай презентацию о Солнечной системе из восьми слайдов». Агент читает скилл, пишет таблицу стилей, план и по одной спецификации страницы на слайд, генерирует две фотографии через <code>threadnoteoffice image</code> и даёт <code>threadnoteoffice slides check</code> отклонить всё, что выходит за границы или перекрывается, прежде чем <code>threadnoteoffice create</code> соберёт <code>.pptx</code>, а <code>slides render</code> вернёт по одному PNG на слайд для просмотра.</td>
<td><b>Установите один раз, через Настройки → Интеграции</b> — ThreadnoteOffice перечисляет кодинг-агентов, найденных на этом компьютере, и записывает скилл в каждый выбранный вами. Либо скачайте скилл в виде zip или выполните <code>install the bundled Threadnote Office skill from Settings</code>. Команды и полный рабочий процесс — в разделе <a href="#command-line-and-agent-skill">Командная строка и агентный скилл</a>.</td>
</tr>
</table>

### 8 · MCP — те же инструменты через Model Context Protocol

Каждая команда `threadnoteoffice` — это ещё и инструмент MCP. Claude Code, Claude
Desktop, Cursor и любой другой MCP-клиент могут сами запустить `threadnoteoffice
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Ускоренная съёмка того, как Claude Code строит восьмислайдовую презентацию для инвесторов о возобновляемой энергетике через MCP-сервер threadnoteoffice: ищет иллюстрации и фотографии, проверяет каждую фотографию-кандидата с помощью media, deck_start пишет таблицу стилей и план, deck_page добавляет по одной проверенной странице за раз, deck_build собирает .pptx и slides_render возвращает изображение каждого слайда; готовая презентация затем открывается в ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides показывает восьмислайдовую презентацию Renewable Energy 2026, которую Claude Code построил через MCP-сервер threadnoteoffice: титульный слайд с фотографией ветропарка на холсте и восемь миниатюр слева"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice Settings, страница Integrations, часть MCP: однострочная команда claude mcp add для Claude Code, JSON-блок для Cursor, Claude Desktop и других MCP-клиентов, и опция локального HTTP-сервера ниже"></td>
</tr>
<tr>
...
- **А также Markdown и HTML**, с той же панелью AI и локальным экспортом в
  Word.
- **Скриптуемость.** Командная строка `threadnoteoffice`, агентный скилл и
...
Всё, что приложения умеют делать с файлом, командная строка `threadnoteoffice` умеет
...
без графического интерфейса. Она устанавливается вместе с ThreadnoteOffice, не
...
| Как                                                         | Что происходит                                                                                                                                                                          |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Настройки → Интеграции** в приложении                     | Показывает агентов, найденных на этом компьютере; один клик записывает скилл в каждый выбранный. Когда релиз ThreadnoteOffice приносит более новый скилл, появляется кнопка **Update**. |
...
| `install the bundled Threadnote Office skill from Settings` | Устанавливает скилл из этого репозитория в любой агент, поддерживающий скиллы.                                                                                                          |

Затем начните новый чат и попросите документ. Скилл учит агента, когда
обращаться к `threadnoteoffice`, как прочитать файл перед редактированием и как
...
с подсказкой об ошибке. `threadnoteoffice help` показывает актуальный набор команд;
...
Внутри `threadnoteoffice` не происходит ни одного вызова модели: агент думает, CLI
собирает и проверяет, а результат открывается в ThreadnoteOffice или PowerPoint как
обычный `.pptx`.
...
Здесь `threadnoteoffice` — это CLI, встроенный в приложение (на macOS —
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; панель
...
операциям как ресурсы `threadnoteoffice://guide/*`, так что скилл не нужен; скилл
...
провайдера, настроенного в ThreadnoteOffice; всё остальное выполняется локально, а
`THREADNOTE_OFFICE_ALLOWED_ROOTS` ограничивает каждый инструмент папками из вашего
списка.
...
только MCP-сервер `threadnoteoffice`:
...
`media` покидали машину — к провайдеру, настроенному в ThreadnoteOffice.
...
| ------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Последний `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote)          |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Последний `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)            |
| **Windows** (x64, большинство ПК)    | Windows 10+, Intel/AMD                                | [Последний установщик `-x64.exe`](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** на Arm (ARM64)           | Windows 11 на Arm (Snapdragon X и аналогичные)        | [Последний установщик `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 или новее)          | [Последний `.deb`](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Последний `.rpm`](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — другие дистрибутивы      | x86_64, glibc 2.34+, FUSE 2                           | [Последний `.AppImage`](https://github.com/ashutosh-rath02/threadnote)             |
...
добавляет ThreadnoteOffice в меню приложений:
...
(`cargo` в PATH); команда `npm run build -w @threadnote/sheets` собирает его
...
ThreadnoteOffice активно развивается, и ваши отзывы влияют на его развитие.

- **Сообщите об ошибке или предложите функцию** в
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Присоединяйтесь к групповому чату ThreadnoteOffice** в
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev), чтобы общаться с командой и другими
  пользователями.
- **Поставьте звезду репозиторию**, если ThreadnoteOffice вам полезен — это лучший
  способ поддержать проект.

## Часто задаваемые вопросы

<details>
<summary><b>ThreadnoteOffice бесплатен?</b></summary>

Да. ThreadnoteOffice бесплатен и распространяется с открытым исходным кодом по
...
<details>
<summary><b>Может ли ThreadnoteOffice открывать файлы Microsoft Word, Excel и PowerPoint?</b></summary>

Да. ThreadnoteOffice открывает и сохраняет нативные файлы `.docx`, `.xlsx` и
...
<details>
<summary><b>Работает ли ThreadnoteOffice офлайн?</b></summary>
...
<details>
<summary><b>Может ли ThreadnoteOffice редактировать файлы PDF?</b></summary>
...
<details>
<summary><b>Может ли ThreadnoteOffice конвертировать PDF в Word, Excel или PowerPoint?</b></summary>
...
Да. Помимо входа через Genspark без ключей, ThreadnoteOffice поддерживает
...
<details>
<summary><b>Может ли ThreadnoteOffice конвертировать HTML в Word?</b></summary>
...
<details>
<summary><b>Могу ли я управлять ThreadnoteOffice из Claude Code, Codex, Cursor или скрипта?</b></summary>

Да. ThreadnoteOffice устанавливает командную строку `threadnoteoffice`, которая запускает те
...
<details>
<summary><b>Собирает ли ThreadnoteOffice какие-либо данные?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md).
...
ThreadnoteOffice был бы невозможен без этих проектов с открытым исходным кодом:
...
ThreadnoteOffice распространяется по лицензии [Apache License 2.0](../../LICENSE),
с одним исключением: каталог `ee/` зарезервирован для будущих корпоративных
модулей и покрывается [ThreadnoteOffice Enterprise License](../../ee/LICENSE).

Названия и логотипы ThreadnoteOffice и Genspark являются товарными знаками Mainfunc,
