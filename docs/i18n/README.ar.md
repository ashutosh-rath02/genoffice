...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — حزمة المكتب المفتوحة المصدر المدعومة بالذكاء الاصطناعي: Docs و Sheets و Slides و PDF و Markdown و HTML مع لوحة ذكاء اصطناعي مدمجة" width="100%">
    </picture>
  </a>
</p>

<h1 align="center" dir="rtl">ThreadnoteOffice</h1>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="الترخيص: Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="أحدث إصدار"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/downloads/ashutosh-rath02/threadnote/total" alt="عدد التنزيلات"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="نجوم GitHub"></a>
</p>
...
<p align="center" dir="rtl">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>الموقع الإلكتروني</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>المجتمع</b></a> ·
  <a href="../../PRIVACY.md"><b>الخصوصية</b></a>
</p>

ThreadnoteOffice بديل مجاني ومفتوح المصدر لـ Microsoft Office على macOS و Windows
...
- **قابل للبرمجة وجاهز للوكلاء.** يأتي التطبيق مع سطر أوامر `threadnoteoffice` ومهارة
...
**الحصول عليه:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon و Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 و Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="تطبيق ThreadnoteOffice Docs يعرض صفحة تقرير سنوي بعمودين مع صورة غلاف بعرض الصفحة كاملة، وجدول مؤشرات أداء مظلّل، وترويسة وتذييل، بتكبير 80% مع لوحة الذكاء الاصطناعي مطوية"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: نظرة عامة عن الشركة مع صورة بانر؛ أعاد الذكاء الاصطناعي صياغة قسم النظرة العامة بإحكام وأضاف قسمًا جديدًا بنقاط، وتوفّر اللوحة تراجعًا بضغطة واحدة"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: أضاف الذكاء الاصطناعي ورقة ملخّص (Summary) تعرض الإيرادات بحسب المنطقة والفئة باستخدام صِيَغ SUMIF، إضافة إلى رسم بياني بالأعمدة، مع تقرير بـ 43 تغييرًا مُطبَّقًا وزر تراجع"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: عند سؤاله عن المنطقة الأعلى إيرادًا في الربع الثاني، يجيب الذكاء الاصطناعي بأوروبا مع تفصيل حسب الفئة، ويستشهد بالخلايا التي استخدمها كروابط، إلى جانب ورقة Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="لقطات متسارعة لـ ThreadnoteOffice Slides وهو يُنشئ عرض المستثمرين Aurora Home: يخطط الذكاء الاصطناعي القصة في اللوحة، وتظهر الشرائح على القماش واحدة تلو الأخرى، وينتهي العرض المكتمل بطلب الإغلاق (closing ask)" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: شريحة الغلاف لعرض تقديمي لمستثمري Aurora Home من إنشاء الذكاء الاصطناعي على لوحة الرسم، مع التوجيه الأصلي المكوَّن من سطر واحد وملخّص الذكاء الاصطناعي لما بناه في اللوحة"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: الشريحة الختامية المصمَّمة لنفس العرض المكوَّن من 11 شريحة، مع شريط المصغّرات على اليسار ولوحة الذكاء الاصطناعي تلخّص السرد القصصي"></td>
</tr>
<tr>
<td dir="rtl"><b>سطر واحد كمُدخل</b> — "أنشئ عرضًا تقديميًا من 10 شرائح لعرضه على المستثمرين لصالح Aurora Home…". يخطّط ThreadnoteOffice للسرد القصصي، ويبحث عن الأرقام، ويُعِدّ مسودة كل شريحة على لوحة الرسم كملف <code>.pptx</code> فعلي.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: يحدّد وضع تحرير النص كل كتلة نصية في الصفحة للتحرير في مكانها، بينما تجيب لوحة الذكاء الاصطناعي عن سؤال حول التقرير مع استشهادات بأرقام الصفحات"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="تطبيق ThreadnoteOffice Docs يعرض مستند Word محوَّلًا محليًا من ملف PDF الخاص بالمراجعة الفصلية لشركة Helios، مفتوحًا في تبويب ثانٍ إلى جانب ملف PDF الأصلي"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="لقطات متسارعة لـ ThreadnoteOffice HTML وهو يعيد تصميم صفحة الوصول الخاصة بـ Lumen: طلب Restyle واحد في اللوحة يحوّل صفحة Midnight Studio الداكنة إلى نسخة Solar Daybreak الدافئة، بينما يبقى كل قسم وكل المحتوى في مكانه" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: صفحة هبوط تم إنشاؤها لمصباح مكتبي يعمل بالطاقة الشمسية باتجاه Midnight Studio الداكن، معروضة في المعاينة المباشرة مع لوحة الذكاء الاصطناعي تلخّص الصفحة التي بنتها للتو"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: واجهة لوحة تحكم شخصية تم إنشاؤها لمصمِّم مستقل بأسلوب كتّاني دافئ، مع شريط جانبي أيسر، وترحيب بخط Serif، وأربع بطاقات مقاييس"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: تقرير بيانات عن سوق السيارات الكهربائية تم إنشاؤه بأسلوب الصحيفة الكبيرة (broadsheet)، مع ترويسة بخط Serif، ورقم عنوان رئيسي بقيمة 17.3 مليون، وصفّ إحصاءات"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: فقرة محدَّدة تعرض نافذة منبثقة Ask AI مع تعليمات مكتوبة وشرائح اقتراحات مثل Polish وMake more concise وExpand وFix grammar، إضافة إلى زرَّي Send now وAdd to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="تطبيق ThreadnoteOffice Markdown يعرض مستند ملاحظات إطلاق يحتوي على جدول، ومخطط تدفّق Mermaid، وقائمة مهام، مع توجيهات البداية الخاصة بلوحة الذكاء الاصطناعي على اليسار"></td>
</tr>
<tr>
...
### 7 · CLI — وكيل البرمجة الخاص بك يقود ThreadnoteOffice، على جهازك

يأتي ThreadnoteOffice مع سطر أوامر `threadnoteoffice` ومهارة وكيل. ثبّت المهارة، وسيتمكّن
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides يعرض عرضًا تقديميًا من ثماني شرائح عن المجموعة الشمسية بناه وكيل برمجة عبر سطر أوامر threadnoteoffice: شريحة الغلاف على لوحة الرسم، وثماني مصغّرات على اليسار، ولوحة الذكاء الاصطناعي مفتوحة" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="إعدادات ThreadnoteOffice، صفحة Integrations: مهارة threadnoteoffice مثبَّتة في Claude Code، مع أزرار Install بجوار Codex وCursor"></td>
</tr>
<tr>
<td dir="rtl"><b>توجيه واحد إلى وكيلك</b> — "أنشئ عرضًا تقديميًا من ثماني شرائح عن المجموعة الشمسية." يقرأ الوكيل المهارة، ويكتب ورقة أنماط ومخططًا ومواصفة صفحة واحدة لكل شريحة، ويولّد الصورتين بواسطة <code>threadnoteoffice image</code>، ويترك <code>threadnoteoffice slides check</code> يرفض أي عنصر يتجاوز الحدود أو يتداخل قبل أن يجمّع <code>threadnoteoffice create</code> ملف <code>.pptx</code> ويُعيد <code>slides render</code> صورة PNG لكل شريحة لمعاينتها.</td>
<td dir="rtl"><b>ثبّت مرة واحدة، من الإعدادات → التكاملات</b> — يسرد ThreadnoteOffice وكلاء البرمجة الذين يجدهم على هذا الجهاز ويكتب المهارة في كل وكيل تختاره. أو نزّل المهارة كملف zip، أو شغّل <code>install the bundled Threadnote Office skill from Settings</code>. الأوامر وسير العمل الكامل في <a href="#command-line-and-agent-skill">سطر الأوامر ومهارة الوكيل</a>.</td>
</tr>
</table>

### 8 · MCP — نفس الأدوات عبر Model Context Protocol

كل أمر من أوامر `threadnoteoffice` هو أيضًا أداة MCP. يمكن لـ Claude Code وClaude
Desktop وCursor وأي عميل MCP آخر تشغيل `threadnoteoffice mcp` بأنفسهم، دون الحاجة
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="لقطات متسارعة لـ Claude Code وهو يبني عرضًا استثماريًا من ثماني شرائح عن الطاقة المتجدّدة عبر خادم MCP الخاص بـ threadnoteoffice: يبحث عن الرسوم البيانية والصور، ويتحقق من كل صورة مرشّحة عبر media، وdeck_start يكتب ورقة الأنماط والمخطط، وdeck_page يضيف صفحة واحدة مُتحقَّقة في كل مرة، وdeck_build يجمّع ملف .pptx، وslides_render يعيد صورة كل شريحة؛ ثم يُفتح العرض النهائي في ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides يعرض عرض Renewable Energy 2026 من ثماني شرائح الذي بناه Claude Code عبر خادم MCP الخاص بـ threadnoteoffice: شريحة الغلاف مع صورة فوتوغرافية لمزرعة رياح على لوحة الرسم وثماني مصغّرات على اليسار"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="إعدادات ThreadnoteOffice، صفحة Integrations، جزء MCP: أمر claude mcp add من سطر واحد لـ Claude Code، وكتلة JSON لـ Cursor وClaude Desktop وعملاء MCP الآخرين، وخيار خادم HTTP المحلي أسفل ذلك"></td>
</tr>
<tr>
...
- **قابل للبرمجة.** سطر أوامر `threadnoteoffice`، ومهارة وكيل، وخادم MCP يضعون كل
...
كل ما تستطيع التطبيقات فعله بملف، يستطيع سطر أوامر `threadnoteoffice` فعله من
...
ThreadnoteOffice، ولا يحتاج إلى بيئة تشغيل خاصة به، ولا يرسل أي مستند إلى أي مكان.
...
| الطريقة                                | ما يحدث                                                                                                                                            |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **الإعدادات → التكاملات** في التطبيق   | يسرد الوكلاء الموجودين على هذا الجهاز؛ وبنقرة واحدة يكتب المهارة في كل وكيل تختاره. ويظهر زر **Update** عندما يصدر إصدار من ThreadnoteOffice بمهارة أحدث. |
...
| `install the bundled Threadnote Office skill from Settings` | يثبّت من هذا المستودع في أي وكيل متوافق مع المهارات.                                                                                               |

ثم ابدأ محادثة جديدة واطلب مستندًا. تعلّم المهارة الوكيل متى يلجأ إلى
`threadnoteoffice`، وكيف يقرأ الملف قبل تحريره، وكيف يتحقّق من عمله بنفسه.
...
`threadnoteoffice help` مجموعة الأوامر الحالية؛ والمرجع الكامل في
...
لا يحدث أي استدعاء لنموذج داخل `threadnoteoffice`: الوكيل هو من يفكّر، وسطر الأوامر
هو من يبني ويتحقّق، وتُفتح النتيجة في ThreadnoteOffice أو PowerPoint كملف `.pptx` عادي.
...
`threadnoteoffice` هنا هو سطر الأوامر المرفق داخل التطبيق (على macOS في
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`؛ تعرض لوحة
الإعدادات المسار الدقيق لتثبيتك). يحمل الخادم تعليمات سير عمله الخاصة
ويعرض مراجع العمليات كموارد `threadnoteoffice://guide/*`، لذا لا حاجة لأي مهارة؛
...
ThreadnoteOffice؛ أما كل شيء آخر فيعمل محليًا، ويحصر `THREADNOTE_OFFICE_ALLOWED_ROOTS` كل
أداة ضمن المجلدات التي تحدّدها.

عرض الطاقة المتجدّدة في العرض التوضيحي أعلاه هو ما يبدو عليه توجيه واحد في
Claude Code، مع تفعيل خادم MCP الخاص بـ `threadnoteoffice` فقط، من جهة البروتوكول:
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **macOS** — شريحة Apple (arm64)      | macOS 11+                                             | [أحدث نسخة `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote) |
| **macOS** — Intel (x64)              | macOS 11+                                             | [أحدث نسخة `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** (x64، لمعظم الأجهزة)     | Windows 10+، معالجات Intel/AMD                        | [أحدث مثبِّت `-x64.exe`](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** على Arm (ARM64)          | Windows 11 على Arm (معالج Snapdragon X وما شابهه)     | [أحدث مثبِّت `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64، glibc 2.34+ (Ubuntu 22.04 أو أحدث)            | [أحدث نسخة `.deb`](https://github.com/ashutosh-rath02/threadnote)         |
| **Linux** — Fedora / RHEL / openSUSE | x86_64، glibc 2.34+ (Fedora 35+، RHEL 9+، Leap 15.6+) | [أحدث نسخة `.rpm`](https://github.com/ashutosh-rath02/threadnote)         |
| **Linux** — توزيعات أخرى             | x86_64، glibc 2.34+، وFUSE 2                          | [أحدث نسخة `.AppImage`](https://github.com/ashutosh-rath02/threadnote)    |

جميع الإصدارات مبنية من الفرع `main`؛ ومثبِّتات macOS و Windows موقَّعة رقميًا.
الإصدارات الأقدم متوفرة في صفحة [Releases](https://github.com/ashutosh-rath02/threadnote).

<details>
<summary><b>التثبيت على Linux</b></summary>

يتم تثبيت حزمة deb باستخدام apt — فيسحب التبعيات المطلوبة ويضيف ThreadnoteOffice إلى
قائمة التطبيقات:
...
`npm run build -w @threadnote/sheets` بتجميعه تلقائيًا. راجع
[CONTRIBUTING.md](../../CONTRIBUTING.md) لمعرفة الفحوصات التي يجب أن يمر بها
كل تغيير وكيفية دمج طلبات السحب (pull requests).

## المجتمع

ThreadnoteOffice قيد تطوير نشط، وملاحظاتك هي ما يشكِّل مستقبله.

- **أبلغ عن خطأ أو اطلب ميزة جديدة** عبر
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **انضم إلى محادثة مجموعة ThreadnoteOffice** على
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) للتواصل مع الفريق والمستخدمين الآخرين.
- **أضِف نجمة (Star) للمستودع** إذا كان ThreadnoteOffice مفيدًا لك — فهذه أفضل طريقة
  لدعم المشروع.

## الأسئلة الشائعة

<details>
<summary><b>هل ThreadnoteOffice مجاني؟</b></summary>

نعم. ThreadnoteOffice مجاني ومفتوح المصدر بموجب ترخيص Apache-2.0 — لا نسخة تجريبية
ولا باقة مدفوعة للتطبيقات نفسها.

</details>

<details>
<summary><b>هل يمكن لـ ThreadnoteOffice فتح ملفات Microsoft Word و Excel و PowerPoint؟</b></summary>

نعم. يفتح ThreadnoteOffice ملفات `.docx` و `.xlsx` و `.pptx` الأصلية ويحفظها.
...
<details>
<summary><b>هل يعمل ThreadnoteOffice دون اتصال بالإنترنت؟</b></summary>
...
<details>
<summary><b>هل يمكن لـ ThreadnoteOffice تحرير ملفات PDF؟</b></summary>
...
<details>
<summary><b>هل يمكن لـ ThreadnoteOffice تحويل PDF إلى Word أو Excel أو PowerPoint؟</b></summary>
...
ThreadnoteOffice استخدام مفتاحك الخاص مع Claude وOpenAI وGemini وDeepSeek وKimi
...
<details>
<summary><b>هل يمكن لـ ThreadnoteOffice تحويل HTML إلى Word؟</b></summary>
...
<details>
<summary><b>هل يمكنني تشغيل ThreadnoteOffice من Claude Code أو Codex أو Cursor أو من سكربت؟</b></summary>

نعم. يثبّت ThreadnoteOffice سطر أوامر `threadnoteoffice` يشغّل المحرّكات نفسها دون واجهة
...
<details>
<summary><b>هل يجمع ThreadnoteOffice أي بيانات؟</b></summary>
...
عناوين البريد الإلكتروني. راجع [ThreadnoteOffice Privacy](../../PRIVACY.md)
...
ما كان لـ ThreadnoteOffice أن يكون ممكنًا لولا هذه المشاريع المفتوحة المصدر:
...
يخضع ThreadnoteOffice لترخيص [Apache License 2.0](../../LICENSE)، مع استثناء واحد:
دليل `ee/` محجوز لوحدات المؤسسات (enterprise) المستقبلية ويخضع لـ
[ThreadnoteOffice Enterprise License](../../ee/LICENSE).

اسما وشعارا ThreadnoteOffice و Genspark هما علامتان تجاريتان مملوكتان لشركة
