...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — suite Office AI open-source: Docs, Sheets, Slides, PDF, Markdown, dan HTML dengan panel AI bawaan" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Situs Web</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Komunitas</b></a> ·
  <a href="../../PRIVACY.md"><b>Privasi</b></a>
</p>

ThreadnoteOffice adalah alternatif Microsoft Office yang gratis dan open-source
...
- **Dapat dijalankan lewat skrip dan siap untuk agen.** Aplikasi ini
  menyertakan baris perintah `threadnoteoffice` dan sebuah skill untuk Claude Code,
...
**Unduh di sini:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon dan Intel) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs menampilkan halaman laporan tahunan dua kolom dengan gambar sampul selebar halaman, tabel KPI berlatar warna, header dan footer, pada zoom 80% dengan panel AI yang diciutkan"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: ringkasan perusahaan dengan gambar banner; AI mempersingkat bagian Overview dan menyisipkan bagian berpoin baru, dan panel menawarkan rollback satu klik"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: AI menambahkan sheet Summary berisi pendapatan per wilayah dan kategori menggunakan rumus SUMIF, ditambah grafik kolom, dan melaporkan 43 perubahan yang diterapkan dengan tombol Undo"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: ditanya wilayah mana yang memimpin pendapatan Q2, AI menjawab Eropa lengkap dengan rincian kategori dan mengutip sel yang digunakan sebagai tautan, di samping sheet Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Time-lapse ThreadnoteOffice Slides membuat deck investor Aurora Home: AI menyusun alur cerita di panel, slide muncul satu demi satu di kanvas, dan deck yang selesai diakhiri dengan closing ask" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: slide sampul deck investor Aurora Home yang dibuat AI di kanvas, dengan prompt satu baris aslinya dan ringkasan AI tentang apa yang dibuatnya di panel"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: slide penutup yang telah didesain dari deck 11-slide yang sama, dengan strip thumbnail di kiri dan panel AI yang meringkas alur ceritanya"></td>
</tr>
<tr>
<td><b>Satu baris prompt masuk</b> — "Buat deck presentasi investor 10-slide untuk Aurora Home…". ThreadnoteOffice merancang alur cerita, meriset angka-angkanya, dan menyusun setiap slide langsung ke kanvas sebagai `.pptx` yang sebenarnya.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: mode Edit text menandai setiap blok teks di halaman untuk diedit langsung di tempat, sementara panel AI menjawab pertanyaan tentang laporan dengan kutipan halaman"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs menampilkan dokumen Word yang dikonversi secara lokal dari PDF Helios quarterly review, dibuka di tab kedua di samping PDF aslinya"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Time-lapse ThreadnoteOffice HTML mengubah gaya halaman landing Lumen: satu permintaan Restyle di panel mengubah halaman Midnight Studio yang gelap menjadi versi Solar Daybreak yang hangat, sementara setiap bagian dan semua konten tetap di tempatnya" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: landing page yang dihasilkan untuk lampu meja tenaga surya dalam arah gaya gelap Midnight Studio, ditampilkan di live preview dengan panel AI meringkas halaman yang baru dibuatnya"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: UI dashboard pribadi yang dihasilkan untuk desainer lepas dalam gaya linen hangat, dengan rail kiri, sapaan bergaya serif, dan empat kartu metrik"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: laporan data pasar kendaraan listrik yang dihasilkan dalam gaya broadsheet, dengan masthead serif, angka utama 17,3 juta, dan baris statistik"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: paragraf yang dipilih menampilkan popover Ask AI dengan instruksi yang diketik dan chip saran seperti Polish, Make more concise, Expand, dan Fix grammar, plus tombol Send now dan Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown merender dokumen catatan peluncuran dengan tabel, flowchart Mermaid, dan daftar tugas, dengan prompt starter panel AI di sebelah kiri"></td>
</tr>
<tr>
...
### 7 · CLI — coding agent Anda menjalankan ThreadnoteOffice, di mesin Anda

ThreadnoteOffice menyertakan baris perintah `threadnoteoffice` dan sebuah skill agen. Pasang
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides menampilkan deck Tata Surya delapan slide yang dibuat coding agent lewat baris perintah threadnoteoffice: slide sampul di kanvas, delapan thumbnail di kiri, dan panel AI terbuka" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice Settings, halaman Integrations: skill threadnoteoffice terpasang di Claude Code, dengan tombol Install di samping Codex dan Cursor"></td>
</tr>
<tr>
<td><b>Satu prompt ke agen Anda</b> — "Buat deck delapan slide tentang Tata Surya." Agen membaca skill, menulis style sheet, outline, dan satu spesifikasi halaman per slide, menghasilkan dua foto dengan <code>threadnoteoffice image</code>, dan membiarkan <code>threadnoteoffice slides check</code> menolak apa pun yang meluap atau tumpang tindih sebelum <code>threadnoteoffice create</code> merakit <code>.pptx</code> dan <code>slides render</code> mengembalikan satu PNG per slide untuk dilihat.</td>
<td><b>Pasang sekali, dari Pengaturan → Integrasi</b> — ThreadnoteOffice menampilkan coding agent yang ditemukannya di komputer ini dan menulis skill ke setiap agen yang Anda pilih. Atau unduh skill sebagai zip, atau jalankan <code>install the bundled Threadnote Office skill from Settings</code>. Perintah dan alur kerja lengkapnya ada di <a href="#command-line-and-agent-skill">Baris perintah dan skill agen</a>.</td>
</tr>
</table>

### 8 · MCP — alat yang sama lewat Model Context Protocol

Setiap perintah `threadnoteoffice` juga merupakan alat MCP. Claude Code, Claude
Desktop, Cursor, dan MCP client lainnya bisa menjalankan sendiri `threadnoteoffice
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Rekaman time-lapse Claude Code membangun briefing investor delapan slide tentang energi terbarukan lewat MCP server threadnoteoffice: mencari figur dan foto, memeriksa setiap foto kandidat dengan media, deck_start menulis style sheet dan outline, deck_page menambahkan satu halaman yang sudah diperiksa setiap kalinya, deck_build merakit .pptx dan slides_render mengembalikan gambar setiap slide; deck yang sudah jadi kemudian terbuka di ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides menampilkan deck Renewable Energy 2026 delapan slide yang dibangun Claude Code lewat MCP server threadnoteoffice: slide sampul dengan foto ladang angin di kanvas dan delapan thumbnail di kiri"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice Settings, halaman Integrations, bagian MCP: perintah satu baris claude mcp add untuk Claude Code, blok JSON untuk Cursor, Claude Desktop, dan MCP client lain, serta opsi server HTTP lokal di bawahnya"></td>
</tr>
<tr>
...
- **Markdown dan HTML juga**, dengan panel AI yang sama dan ekspor lokal ke
  Word.
- **Dapat dijalankan lewat skrip.** Baris perintah `threadnoteoffice`, skill agen,
...
perintah `threadnoteoffice` dari terminal: memeriksa, mengonversi, membuat, membaca,
dan mengedit Word, Excel, PowerPoint, PDF, Markdown, dan HTML dengan engine
yang sama, secara headless. Ia terpasang bersama ThreadnoteOffice, tidak memerlukan
...
tersentuh dan mengembalikan pesan kesalahan berpanduan. `threadnoteoffice help`
...
Tidak ada panggilan model yang terjadi di dalam `threadnoteoffice`: agen yang
berpikir, CLI yang membangun dan memeriksa, dan hasilnya terbuka di ThreadnoteOffice
...
`threadnoteoffice` di sini adalah CLI yang disertakan di dalam aplikasi (di macOS
...
resource `threadnoteoffice://guide/*`, jadi skill tidak diperlukan; skill dan
...
ThreadnoteOffice; sisanya berjalan lokal, dan `THREADNOTE_OFFICE_ALLOWED_ROOTS` membatasi
...
yang keluar dari mesin, ke penyedia yang dikonfigurasi di ThreadnoteOffice.
...
| **Windows** di Arm (ARM64)           | Windows 11 on Arm (Snapdragon X dan sejenisnya)       | [Installer `-arm64.exe` terbaru](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 atau lebih baru)    | [`.deb` terbaru](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [`.rpm` terbaru](https://github.com/ashutosh-rath02/threadnote)                 |
| **Linux** — distribusi lainnya       | x86_64, glibc 2.34+, FUSE 2                           | [`.AppImage` terbaru](https://github.com/ashutosh-rath02/threadnote)            |
...
menambahkan ThreadnoteOffice ke menu aplikasi:
...
(`cargo` di PATH); `npm run build -w @threadnote/sheets` mengompilasinya
...
ThreadnoteOffice terus dikembangkan secara aktif dan masukan Anda membentuk arahnya.

- **Laporkan bug atau ajukan permintaan fitur** di
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Gabung ke grup chat ThreadnoteOffice** di
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) untuk mengobrol dengan tim dan
  pengguna lain.
- **Beri bintang (star) pada repo ini** jika ThreadnoteOffice bermanfaat bagi Anda —
  ini cara terbaik untuk mendukung proyek ini.

## FAQ

<details>
<summary><b>Apakah ThreadnoteOffice gratis?</b></summary>

Ya. ThreadnoteOffice gratis dan open-source di bawah lisensi Apache-2.0 — tidak ada
masa coba, tidak ada tingkatan berbayar untuk aplikasinya sendiri.

</details>

<details>
<summary><b>Apakah ThreadnoteOffice bisa membuka file Microsoft Word, Excel, dan PowerPoint?</b></summary>

Ya. ThreadnoteOffice membuka dan menyimpan file `.docx`, `.xlsx`, dan `.pptx` asli.
...
<details>
<summary><b>Apakah ThreadnoteOffice bisa digunakan secara offline?</b></summary>
...
<details>
<summary><b>Apakah ThreadnoteOffice bisa mengedit file PDF?</b></summary>
...
<details>
<summary><b>Apakah ThreadnoteOffice bisa mengonversi PDF ke Word, Excel, atau PowerPoint?</b></summary>
...
Ya. Selain masuk lewat Genspark tanpa kunci API, ThreadnoteOffice mendukung
...
<details>
<summary><b>Apakah ThreadnoteOffice bisa mengonversi HTML ke Word?</b></summary>
...
<details>
<summary><b>Bisakah saya menjalankan ThreadnoteOffice dari Claude Code, Codex, Cursor, atau skrip?</b></summary>

Ya. ThreadnoteOffice memasang baris perintah `threadnoteoffice` yang menjalankan engine yang
...
<details>
<summary><b>Apakah ThreadnoteOffice mengumpulkan data?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md) untuk daftar lengkap event dan
pengungkapan data.
...
ThreadnoteOffice tidak akan mungkin ada tanpa proyek-proyek open-source berikut:
...
ThreadnoteOffice dilisensikan di bawah [Apache License 2.0](../../LICENSE), dengan
satu pengecualian: direktori `ee/` dicadangkan untuk modul enterprise di masa
depan dan tercakup oleh [ThreadnoteOffice Enterprise License](../../ee/LICENSE).

Nama dan logo ThreadnoteOffice serta Genspark adalah merek dagang milik Mainfunc,
