...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — חבילת האופיס מבוססת ה-AI בקוד פתוח: Docs,‏ Sheets,‏ Slides,‏ PDF,‏ Markdown ו-HTML עם פאנל AI מובנה" width="100%">
    </picture>
  </a>
</p>
...
<p align="center" dir="rtl">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>אתר</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>קהילה</b></a> ·
  <a href="../../PRIVACY.md"><b>פרטיות</b></a>
</p>

ThreadnoteOffice היא חלופה חינמית ובקוד פתוח ל-Microsoft Office עבור macOS,‏
...
- **ניתן לסקריפטים ומוכן לסוכנים.** האפליקציה מגיעה עם שורת פקודה `threadnoteoffice`
...
**להורדה:** [macOS](https://github.com/ashutosh-rath02/threadnote) ‏(Apple Silicon ו-Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) ‏(x64 ו-Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs מציג עמוד דו-טורי מדוח שנתי עם תמונת שער ברוחב מלא, טבלת KPI מוצללת, כותרת עליונה ותחתונה, בתקריב של 80% עם פאנל ה-AI מכווץ"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: סקירת חברה עם תמונת באנר; ה-AI חידד את קטע ה-Overview והוסיף קטע חדש עם תבליטים, והפאנל מציע שחזור בלחיצה אחת"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: ה-AI הוסיף גיליון Summary עם הכנסות לפי אזור וקטגוריה באמצעות נוסחאות SUMIF, בתוספת תרשים עמודות, ומדווח על 43 שינויים שהוחלו עם כפתור ביטול"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: בתשובה לשאלה איזה אזור הוביל בהכנסות ברבעון השני, ה-AI עונה אירופה עם פירוט לפי קטגוריה, ומצטט כקישורים את התאים שבהם השתמש, לצד גיליון Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="טיים-לאפס של ThreadnoteOffice Slides יוצר את מצגת המשקיעים Aurora Home: ה-AI מתכנן את קו העלילה בפאנל, השקופיות מופיעות על הקנבס אחת אחרי השנייה, והמצגת המוגמרת מסתיימת בבקשת הסגירה (closing ask)" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: שקופית השער של מצגת משקיעים בשם Aurora Home שנוצרה על ידי AI, על הקנבס, עם הפרומפט המקורי בשורה אחת וסיכום ה-AI של מה שנבנה בפאנל"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: שקופית הסיום המעוצבת של אותה מצגת בת 11 שקופיות, עם רצועת התמונות הממוזערות בצד שמאל ופאנל ה-AI מסכם את קו העלילה"></td>
</tr>
<tr>
<td dir="rtl"><b>שורה אחת בכניסה</b> — ״צרו מצגת משקיעים בת 10 שקופיות בשביל Aurora Home…״. ThreadnoteOffice מתכננת את קו העלילה, חוקרת את המספרים, ומכינה כל שקופית ישירות על הקנבס כקובץ <code>.pptx</code> אמיתי.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: מצב 'ערוך טקסט' מתאר בקו כל בלוק טקסט בעמוד לעריכה במקום, בזמן שפאנל ה-AI עונה על שאלה בנוגע לדוח עם ציטוטים למספרי עמוד"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs מציג מסמך Word שהומר באופן מקומי מקובץ ה-PDF של סיכום הרבעון של Helios, ונפתח בכרטיסייה שנייה לצד קובץ ה-PDF המקורי"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="טיים-לאפס של ThreadnoteOffice HTML משנה את העיצוב של דף הנחיתה של Lumen: בקשת Restyle אחת בפאנל הופכת את הדף הכהה של Midnight Studio לגרסת Solar Daybreak החמימה, בעוד כל קטע וכל התוכן נשארים במקומם" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: עמוד נחיתה שנוצר עבור מנורת שולחן סולארית בכיוון העיצובי הכהה Midnight Studio, מוצג בתצוגה המקדימה החיה עם פאנל ה-AI מסכם את העמוד שבנה"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: ממשק דשבורד אישי שנוצר לעצמאי/ת בתחום העיצוב, בסטייל 'לינן' חם, עם עמודת ניווט בצד שמאל, ברכה בגופן serif וארבעה כרטיסי מדדים"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: דוח נתונים על שוק הרכב החשמלי (EV) שנוצר בסטייל 'עיתון רחב' (broadsheet), עם כותרת ראשית בגופן serif, נתון כותרת של 17.3 מיליון ושורת סטטיסטיקות"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: פסקה מסומנת מציגה חלונית קופצת Ask AI עם הנחיה מוקלדת וצ'יפים של הצעות כמו Polish,‏ Make more concise,‏ Expand ו-Fix grammar, וגם כפתורי Send now ו-Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown מציג מסמך הערות השקה עם טבלה, תרשים זרימה של Mermaid ורשימת משימות, עם פרומפטי הפתיחה של פאנל ה-AI בצד שמאל"></td>
</tr>
<tr>
...
### 7 · CLI — סוכן הקוד שלכם מפעיל את ThreadnoteOffice, על המחשב שלכם

ThreadnoteOffice מגיעה עם שורת פקודה `threadnoteoffice` ועם skill לסוכנים. התקינו את
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides מציג מצגת בת שמונה שקופיות על מערכת השמש שסוכן קוד בנה דרך שורת הפקודה threadnoteoffice: שקופית השער על הקנבס, שמונה תמונות ממוזערות בצד שמאל ופאנל ה-AI פתוח" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="הגדרות ThreadnoteOffice, עמוד Integrations: ה-skill של threadnoteoffice מותקן ב-Claude Code, עם כפתורי Install ליד Codex ו-Cursor"></td>
</tr>
<tr>
<td dir="rtl"><b>פרומפט אחד לסוכן שלכם</b> — ״בנו מצגת בת שמונה שקופיות על מערכת השמש.״ הסוכן קורא את ה-skill, כותב גיליון סטייל, מתווה ומפרט עמוד אחד לכל שקופית, מייצר את שתי התמונות עם <code>threadnoteoffice image</code>, ונותן ל-<code>threadnoteoffice slides check</code> לדחות כל דבר שגולש או חופף לפני ש-<code>threadnoteoffice create</code> מרכיב את ה-<code>.pptx</code> ו-<code>slides render</code> מחזיר PNG לכל שקופית להתרשמות.</td>
<td dir="rtl"><b>התקינו פעם אחת, מתוך הגדרות → שילובים</b> — ThreadnoteOffice מציגה את סוכני הקוד שהיא מוצאת על המחשב הזה וכותבת את ה-skill לכל אחד שתבחרו. או הורידו את ה-skill כ-zip, או הריצו <code>install the bundled Threadnote Office skill from Settings</code>. הפקודות ותהליך העבודה המלא נמצאים ב<a href="#command-line-and-agent-skill">שורת הפקודה וה-skill לסוכנים</a>.</td>
</tr>
</table>

### 8 · MCP — אותם כלים דרך Model Context Protocol

כל פקודת `threadnoteoffice` היא גם כלי MCP. Claude Code,‏ Claude Desktop,‏ Cursor
וכל לקוח MCP אחר יכולים להפעיל בעצמם את `threadnoteoffice mcp`, בלי צורך להתקין
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="צילום מואץ של Claude Code בונה תדריך משקיעים בן שמונה שקופיות על אנרגיה מתחדשת דרך שרת ה-MCP של threadnoteoffice: מחפש איורים ותמונות, בודק כל תמונה מועמדת עם media, deck_start כותב את גיליון הסטייל והתווה, deck_page מוסיף עמוד מאומת אחד בכל פעם, deck_build מרכיב את קובץ ה-.pptx ו-slides_render מחזיר תמונה של כל שקופית; המצגת המוגמרת נפתחת לאחר מכן ב-ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides מציג את מצגת Renewable Energy 2026 בת שמונה השקופיות ש-Claude Code בנה דרך שרת ה-MCP של threadnoteoffice: שקופית השער עם תצלום של חוות רוח על הקנבס ושמונה תמונות ממוזערות בצד שמאל"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="הגדרות ThreadnoteOffice, עמוד Integrations, חלק ה-MCP: פקודת claude mcp add בשורה אחת עבור Claude Code, בלוק ה-JSON עבור Cursor,‏ Claude Desktop ולקוחות MCP אחרים, ואפשרות שרת ה-HTTP המקומי מתחת"></td>
</tr>
<tr>
...
- **ניתן לסקריפטים.** שורת פקודה `threadnoteoffice`, skill לסוכנים ושרת MCP
...
כל מה שהאפליקציות יכולות לעשות לקובץ, שורת הפקודה `threadnoteoffice` יכולה לעשות
מהטרמינל: לבדוק, להמיר, ליצור, לקרוא ולערוך Word,‏ Excel,‏ PowerPoint,‏ PDF,‏
Markdown ו-HTML על אותם מנועים, ללא ממשק גרפי. היא מותקנת יחד עם ThreadnoteOffice,
...
| איך                                                         | מה קורה                                                                                                                                                    |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **הגדרות → שילובים** באפליקציה                              | מציג את הסוכנים שנמצאו על המחשב הזה; לחיצה אחת כותבת את ה-skill לכל אחד שתבחרו. כפתור **Update** מופיע כשגרסת ThreadnoteOffice חדשה מגיעה עם skill מעודכן. |
| **הורדה כ-zip** באותו העמוד                                 | המבנה ש-claude.ai, אפליקציות Claude לדסקטופ ועוזרים אחרים מקבלים כ-skill שהועלה.                                                                           |
| `install the bundled Threadnote Office skill from Settings` | מתקין מהמאגר הזה לכל סוכן שתומך ב-skills.                                                                                                                  |

לאחר מכן פתחו צ'אט חדש ובקשו מסמך. ה-skill מלמד את הסוכן מתי לפנות
ל-`threadnoteoffice`, איך לקרוא קובץ לפני שעורכים אותו, ואיך לבדוק את העבודה של
עצמו.
...
`threadnoteoffice help` מציג את מערך הפקודות הנוכחי; התיעוד המלא נמצא
...
שום קריאה למודל לא מתבצעת בתוך `threadnoteoffice`: הסוכן חושב, ה-CLI בונה ובודק,
והתוצאה נפתחת ב-ThreadnoteOffice או ב-PowerPoint כקובץ `.pptx` רגיל.
...
| דרך                                     | מה זה                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A ·‏ `threadnoteoffice mcp`** (מומלץ) | שרת stdio שהעוזר מפעיל בעצמו; אין צורך ש-ThreadnoteOffice יהיה פתוח. כלי אחד לכל פקודה (`info`,‏ `convert`,‏ `create_docx`,‏ `create_xlsx`,‏ `create_pptx`,‏ `create_pdf`,‏ `docs_read` / `docs_apply` / `docs_check`,‏ `sheet_*`,‏ `slides_*`,‏ `render`,‏ `guide`,‏ `search`,‏ `image`,‏ `media`,‏ `open`) ובנוסף תהליך המצגת המדורג `deck_start` → `deck_page` → `deck_build` → `deck_replace`. פעולות, מפרטים ו-Markdown מועברים ישירות בקריאה, כך שגם לקוח בלי מערכת קבצים עובד. |
| **B · שרת HTTP מקומי**                  | רץ בתוך אפליקציית ThreadnoteOffice בכתובת `http://127.0.0.1:3093/mcp` (Streamable HTTP, עם SSE ישן לתאימות). הכלים שלו מפעילים לשונית עורך Word גלויה: `create_session`,‏ `insert_content`,‏ `replace_blocks`,‏ `apply_ops`,‏ `read_document`,‏ `save_session`, ואתם צופים במסמך מקבל צורה. כבוי כברירת מחדל; הפעילו אותו באותה חלונית הגדרות.                                                                                                                                        |
...
`threadnoteoffice` כאן הוא ה-CLI המצורף בתוך האפליקציה (ב-macOS
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; חלונית
ההגדרות מציגה את הנתיב המדויק להתקנה שלכם). השרת נושא הוראות תהליך עבודה
משלו וחושף את מדריכי הפעולות כמשאבי `threadnoteoffice://guide/*`, כך שאין צורך
...
שהוגדר ב-ThreadnoteOffice; כל השאר רץ מקומית, ו-`THREADNOTE_OFFICE_ALLOWED_ROOTS` מגביל
כל כלי לתיקיות שציינתם.

מצגת האנרגיה המתחדשת בהדגמה למעלה היא איך שנראה פרומפט אחד ב-Claude Code
עם שרת ה-MCP של `threadnoteoffice` בלבד מחובר, מצד הפרוטוקול:
...
`search` ו-`media` יצאו מהמכונה, אל הספק המוגדר ב-ThreadnoteOffice.
...
| ------------------------------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                                 | [הגרסה האחרונה של `.dmg` (arm64)](https://github.com/ashutosh-rath02/threadnote)     |
| **macOS** — Intel (x64)              | macOS 11+                                                 | [הגרסה האחרונה של `.dmg` (x64)](https://github.com/ashutosh-rath02/threadnote)       |
| **Windows** (x64, רוב המחשבים)       | Windows 10+, Intel/AMD                                    | [הגרסה האחרונה של מתקין `-x64.exe`](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** על Arm (ARM64)           | Windows 11 על Arm (Snapdragon X ומעבדים דומים)            | [הגרסה האחרונה של מתקין `-arm64.exe`](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64,‏ glibc 2.34+‎ (Ubuntu 22.04 ואילך)                | [הגרסה האחרונה של `.deb`](https://github.com/ashutosh-rath02/threadnote)             |
| **Linux** — Fedora / RHEL / openSUSE | x86_64,‏ glibc 2.34+‎ (Fedora 35+,‏ RHEL 9+,‏ Leap 15.6+) | [הגרסה האחרונה של `.rpm`](https://github.com/ashutosh-rath02/threadnote)             |
| **Linux** — הפצות אחרות              | x86_64,‏ glibc 2.34+‎, FUSE 2                             | [הגרסה האחרונה של `.AppImage`](https://github.com/ashutosh-rath02/threadnote)        |
...
קובץ ה-deb מותקן באמצעות apt — הוא מוריד את יחסי התלות ומוסיף את ThreadnoteOffice
לתפריט האפליקציות:
...
```bash
sudo dnf install ./threadnoteoffice-<version>.x86_64.rpm     # Fedora / משפחת RHEL
...
ה-xlsx (`cargo` נגיש ב-PATH); `npm run build -w @threadnote/sheets` מקמפל
אותו אוטומטית. ראו [CONTRIBUTING.md](../../CONTRIBUTING.md) לבדיקות שכל
שינוי חייב לעבור ולאופן שבו pull requests מתקבלים.

## קהילה

ThreadnoteOffice נמצאת בפיתוח פעיל, והמשוב שלכם מעצב אותה.

- **דווחו על באג או בקשו פיצ'ר** ב-
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **הצטרפו לצ'אט הקבוצתי של ThreadnoteOffice** ב-
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) כדי לדבר עם הצוות ועם משתמשים אחרים.
- **תנו כוכב (star) למאגר** אם ThreadnoteOffice שימושית לכם — זו הדרך הטובה ביותר
  לתמוך בפרויקט.

## שאלות נפוצות

<details>
<summary><b>האם ThreadnoteOffice חינמית?</b></summary>

כן. ThreadnoteOffice חינמית ובקוד פתוח, בהתאם לרישיון Apache-2.0 — אין תקופת
ניסיון ואין מסלול בתשלום לאפליקציות עצמן.

</details>

<details>
<summary><b>האם ThreadnoteOffice יכולה לפתוח קבצי Microsoft Word,‏ Excel ו-PowerPoint?</b></summary>

כן. ThreadnoteOffice פותחת ושומרת קבצי `.docx`,‏ `.xlsx` ו-`.pptx` מקוריים.
...
<details>
<summary><b>האם ThreadnoteOffice עובדת באופן לא מקוון?</b></summary>
...
<details>
<summary><b>האם ThreadnoteOffice יכולה לערוך קבצי PDF?</b></summary>
...
<details>
<summary><b>האם ThreadnoteOffice יכולה להמיר PDF ל-Word,‏ Excel או PowerPoint?</b></summary>
...
כן. מעבר להתחברות ל-Genspark שאינה דורשת מפתח, ThreadnoteOffice מאפשרת להביא מפתח
...
<details>
<summary><b>האם ThreadnoteOffice יכולה להמיר HTML ל-Word?</b></summary>
...
<details>
<summary><b>האם אפשר להפעיל את ThreadnoteOffice מתוך Claude Code,‏ Codex,‏ Cursor או מסקריפט?</b></summary>

כן. ThreadnoteOffice מתקינה שורת פקודה `threadnoteoffice` שמריצה את אותם מנועים ללא ממשק
...
<details>
<summary><b>האם ThreadnoteOffice אוספת מידע?</b></summary>
...
ThreadnoteOffice לא הייתה יכולה להתקיים בלי הפרויקטים הבאים בקוד פתוח:
...
ThreadnoteOffice מופצת ברישיון [Apache License 2.0](../../LICENSE), עם חריג אחד:
התיקייה `ee/` שמורה למודולים עסקיים (enterprise) עתידיים, והיא כפופה
ל-[ThreadnoteOffice Enterprise License](../../ee/LICENSE).

השמות והלוגואים ThreadnoteOffice ו-Genspark הם סימנים מסחריים של Mainfunc, Inc.
