...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice —— 开源 AI 办公套件：Docs、Sheets、Slides、PDF、Markdown 和 HTML，内置 AI 面板" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="许可证：Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="最新版本"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/downloads/ashutosh-rath02/threadnote/total" alt="下载量"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="GitHub Star 数"></a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>官网</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>社区</b></a> ·
  <a href="../../PRIVACY.md"><b>隐私</b></a>
</p>

ThreadnoteOffice 是一款免费、开源的 Microsoft Office 替代品，支持 macOS、Windows
...
- **可脚本化，随时可供智能体调用。** 应用自带 `threadnoteoffice` 命令行和一份面向
  Claude Code、Codex、Cursor、Gemini CLI、GitHub Copilot、OpenCode 和 Windsurf
  的 agent skill，让编程智能体无需打开任何窗口，就能在你的电脑上创建、转换、
  读取和编辑真正的 Office 文件。

**获取：** [macOS](https://github.com/ashutosh-rath02/threadnote)（Apple Silicon 和 Intel）·
[Windows](https://github.com/ashutosh-rath02/threadnote)（x64 和 Arm）·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs 以 80% 缩放渲染一页双栏年报，包含通栏封面图、底纹 KPI 表格、页眉和页脚，AI 面板处于折叠状态"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs：一份带横幅图片的公司简介；AI 精简了「概述」部分并插入了一个新的项目符号章节，面板提供一键回滚"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets：AI 新增了一张「汇总」工作表，用 SUMIF 公式按地区和类别统计收入，并插入了柱状图，报告已应用 43 项更改并提供撤销按钮"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets：被问到哪个地区在第二季度收入领先时，AI 回答「欧洲」并给出类别拆分，同时以链接形式引用所用的单元格，旁边是「订单」工作表"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="ThreadnoteOffice Slides 生成 Aurora Home 投资人演示文稿的过程延时：AI 在面板中规划叙事线，幻灯片依次出现在画布上，最终演示文稿以收尾的诉求结束" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides：画布上是 AI 生成的 Aurora Home 投资人演示文稿封面页，面板中显示最初的一行提示词以及 AI 对所生成内容的总结"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides：同一份 11 页演示文稿中经过设计的结尾页，左侧是缩略图栏，AI 面板正在总结故事线"></td>
</tr>
<tr>
<td><b>输入一句话</b> —— “为 Aurora Home 制作一份 10 页的投资人融资演示文稿……”。ThreadnoteOffice 规划故事线、调研数据，并把每一页直接生成到画布上，成为真正的 <code>.pptx</code>。</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF：「编辑文字」模式为页面上每个文本块勾勒出边框以便原位编辑，同时 AI 面板正在回答关于这份报告的问题并附带页码引用"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs 显示一份由 Helios 季度回顾 PDF 在本机转换而来的 Word 文档，在原 PDF 旁边的第二个标签页中打开"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="ThreadnoteOffice HTML 重新设计 Lumen 落地页的过程延时：面板中一次 Restyle 请求就把深色的 Midnight Studio 页面变成暖色的 Solar Daybreak 版本，而每个板块和全部文案都保持不变" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML：为一款太阳能台灯生成的落地页，采用深色的 Midnight Studio 风格方向，显示在实时预览中，AI 面板正在总结刚构建的页面"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML：为一位自由设计师生成的个人工作台 UI，采用暖色亚麻风格，包含左侧导航栏、衬线体问候语和四张指标卡片"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML：以大报风格生成的电动车市场数据报告，包含衬线体报头、1730 万的头条数字和一行统计数据"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown：选中一个段落后弹出 Ask AI 浮层，其中有已输入的指令和「润色」「更简洁」「扩写」「修正语法」等建议芯片，以及「立即发送」和「加入队列」按钮"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown 渲染一份发布说明文档，包含表格、Mermaid 流程图和任务列表，左侧是 AI 面板的起手提示词"></td>
</tr>
<tr>
...
### 7 · CLI —— 让你的编程智能体在本机驱动 ThreadnoteOffice

ThreadnoteOffice 自带 `threadnoteoffice` 命令行和一份 agent skill。安装这份 skill 之后，
Claude Code、Codex、Cursor、Gemini CLI、GitHub Copilot、OpenCode 或 Windsurf
就能通过与应用相同的引擎创建、转换、读取和编辑真正的 Office 文件，无需打开
任何窗口。

<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides 中显示一份由编程智能体通过 threadnoteoffice 命令行制作的八页太阳系演示文稿：画布上是封面页，左侧是八张缩略图，AI 面板处于打开状态" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice 设置的「集成」页面：threadnoteoffice skill 已安装到 Claude Code，Codex 和 Cursor 旁边显示着「安装」按钮"></td>
</tr>
<tr>
<td><b>给智能体一句提示词</b> —— “制作一份关于太阳系的八页演示文稿。”智能体读取 skill，依次写出样式表、大纲和每页一份的页面规格，用 <code>threadnoteoffice image</code> 生成两张图片，再由 <code>threadnoteoffice slides check</code> 拦下所有溢出或重叠的内容，最后由 <code>threadnoteoffice create</code> 组装出 <code>.pptx</code>，并用 <code>slides render</code> 为每一页交回一张 PNG 供查看。</td>
<td><b>在设置 → 集成中一次安装</b> —— ThreadnoteOffice 会列出在这台电脑上找到的编程智能体，并把 skill 写入你选中的每一个。也可以把 skill 下载为 zip 压缩包，或运行 <code>install the bundled Threadnote Office skill from Settings</code>。命令和完整工作流见<a href="#command-line-and-agent-skill">命令行与 agent skill</a>。</td>
</tr>
</table>

### 8 · MCP —— 通过 Model Context Protocol 提供的同一套工具

每一条 `threadnoteoffice` 命令同时也是一个 MCP 工具。Claude Code、Claude Desktop、
Cursor 及任何其他 MCP 客户端都能自行启动 `threadnoteoffice mcp`，无需安装 skill，
也无需打开任何窗口，即可获得 29 个工具以及以资源形式提供的操作参考文档。
应用内置的第二个 HTTP 服务器，还能让智能体在一个可见的编辑器标签页中构建
Word 文档，供你实时查看。

<img src="../assets/readme/mcp-deck-motion.webp" alt="Claude Code 通过 threadnoteoffice MCP 服务器构建一份八页可再生能源投资简报的过程延时：它会搜索图表和照片，并用 media 检查每一张候选图片，deck_start 写入样式表和大纲，deck_page 逐页添加经过检查的页面，deck_build 组装出 .pptx，slides_render 返回每一页的图片；最终这份演示文稿会在 ThreadnoteOffice Slides 中打开" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides 中显示 Claude Code 通过 threadnoteoffice MCP 服务器构建的八页可再生能源 2026 演示文稿：画布上是带有风电场照片的封面页，左侧是八张缩略图"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice 设置的「集成」页面，MCP 部分：Claude Code 对应的一行 claude mcp add 命令，Cursor、Claude Desktop 及其他 MCP 客户端对应的 JSON 代码块，以及下方的本地 HTTP 服务器选项"></td>
</tr>
<tr>
...
- **可脚本化。** `threadnoteoffice` 命令行、agent skill 和 MCP 服务器让每一个引擎都能
...
应用能对文件做的一切，`threadnoteoffice` 命令行都能在终端里完成：检查、转换、创建、
读取和编辑 Word、Excel、PowerPoint、PDF、Markdown 和 HTML，用的是同一套引擎，
无需界面。它随 ThreadnoteOffice 一起安装，不需要自己的运行时，也绝不会把文档发送到
...
| 方式                                                        | 效果                                                                                                                                   |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| 应用内的 **设置 → 集成**                                    | 列出在这台电脑上找到的智能体；一键即可把 skill 写入你选中的每一个。当 ThreadnoteOffice 新版本附带更新的 skill 时，会出现**更新**按钮。 |
| 同一页面上的 **下载为 zip**                                 | claude.ai、Claude 桌面应用及其他助手可作为上传 skill 接受的目录结构。                                                                  |
| `install the bundled Threadnote Office skill from Settings` | 从本仓库安装到任何兼容 skills 的智能体。                                                                                               |

然后开启一个新对话，让它帮你做一份文档。这份 skill 会教智能体何时该用
`threadnoteoffice`、编辑前如何先读取文件，以及如何检查自己的成果。
...
被拒绝的操作不会改动文件，并会返回带有指引的错误信息。`threadnoteoffice help` 列出
...
`threadnoteoffice` 内部不会发起任何模型调用：思考由智能体负责，构建和检查由 CLI
负责，最后的成果会以一份普通的 `.pptx` 在 ThreadnoteOffice 或 PowerPoint 中打开。
...
| 方式                                   | 内容                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A · `threadnoteoffice mcp`**（推荐） | 一个由助手自行启动的 stdio 服务器，ThreadnoteOffice 无需处于打开状态。每条命令对应一个工具（`info`、`convert`、`create_docx`、`create_xlsx`、`create_pptx`、`create_pdf`、`docs_read` / `docs_apply` / `docs_check`、`sheet_*`、`slides_*`、`render`、`guide`、`search`、`image`、`media`、`open`），再加上分阶段的幻灯片构建流程 `deck_start` → `deck_page` → `deck_build` → `deck_replace`。Ops、spec 和 Markdown 都以内联方式传入，因此没有文件系统的客户端同样可以正常工作。 |
| **B · 本地 HTTP 服务器**               | 运行在 ThreadnoteOffice 应用内部，地址为 `http://127.0.0.1:3093/mcp`（Streamable HTTP，兼容旧版 SSE）。它的工具驱动一个可见的 Word 编辑器标签页：`create_session`、`insert_content`、`replace_blocks`、`apply_ops`、`read_document`、`save_session`，你可以实时看着文档成形。默认关闭；在同一个设置面板中开启。                                                                                                                                                                  |
...
这里的 `threadnoteoffice` 就是应用内置的那个 CLI（在 macOS 上位于
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`；设置面板会
打印出你本机安装的确切路径）。这个服务器自带工作流说明，并把操作参考文档以
`threadnoteoffice://guide/*` 资源的形式暴露出来，因此不需要额外的 skill；skill 和
MCP 服务器可以共存，由助手自行选择使用哪一个。云端能力（`search`、`image`、
`media`）仍然经由 ThreadnoteOffice 中配置的服务商完成；其余一切都在本机运行，
`THREADNOTE_OFFICE_ALLOWED_ROOTS` 会把每个工具都限制在你列出的文件夹之内。

上方演示中的可再生能源演示文稿，就是仅接入 `threadnoteoffice` MCP 服务器时，
...
三十八次调用，大约十三分钟，助手全程没有碰过终端：图表、照片、指南、检查和渲染结果都是作为 MCP 工具结果传递的。只有 `search` 和 `media` 离开过本机，发往 ThreadnoteOffice 中配置的服务商。
...
| 平台                                  | 系统要求                                               | 下载                                                                        |
| ------------------------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------- |
| **macOS** —— Apple Silicon (arm64)    | macOS 11+                                              | [最新 `.dmg`（arm64）](https://github.com/ashutosh-rath02/threadnote)       |
| **macOS** —— Intel (x64)              | macOS 11+                                              | [最新 `.dmg`（x64）](https://github.com/ashutosh-rath02/threadnote)         |
| **Windows**（x64，大多数 PC）         | Windows 10+，Intel/AMD                                 | [最新 `-x64.exe` 安装程序](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** on Arm（ARM64）           | Windows 11 on Arm（Snapdragon X 及同类芯片）           | [最新 `-arm64.exe` 安装程序](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** —— Debian / Ubuntu          | x86_64，glibc 2.34+（Ubuntu 22.04 或更新）             | [最新 `.deb`](https://github.com/ashutosh-rath02/threadnote)                |
| **Linux** —— Fedora / RHEL / openSUSE | x86_64，glibc 2.34+（Fedora 35+、RHEL 9+、Leap 15.6+） | [最新 `.rpm`](https://github.com/ashutosh-rath02/threadnote)                |
| **Linux** —— 其他发行版               | x86_64，glibc 2.34+，FUSE 2                            | [最新 `.AppImage`](https://github.com/ashutosh-rath02/threadnote)           |

所有构建均来自 `main` 分支；macOS 和 Windows 安装程序均已签名。
历史版本见 [Releases](https://github.com/ashutosh-rath02/threadnote) 页面。

<details>
<summary><b>在 Linux 上安装</b></summary>

deb 包通过 apt 安装 —— 会自动拉取依赖并把 ThreadnoteOffice 添加到应用程序菜单：
...
`npm run build -w @threadnote/sheets` 会自动编译它。每项改动必须通过的检查以及
拉取请求的合入流程见 [CONTRIBUTING.md](../../CONTRIBUTING.md)。

## 社区

ThreadnoteOffice 正在积极开发中，你的反馈决定它的走向。

- **报告 bug 或提出功能需求**，请到
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues)。
- **加入 ThreadnoteOffice 群聊**，在
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) 上与团队和其他用户交流。
- **给仓库点个 Star** —— 如果 ThreadnoteOffice 对你有用，这是支持项目最好的方式。

## 常见问题

<details>
<summary><b>ThreadnoteOffice 是免费的吗？</b></summary>

是的。ThreadnoteOffice 免费且开源，采用 Apache-2.0 许可证 —— 没有试用期，应用本身也
没有付费档。

</details>

<details>
<summary><b>ThreadnoteOffice 能打开 Microsoft Word、Excel 和 PowerPoint 文件吗？</b></summary>

可以。ThreadnoteOffice 直接打开并保存原生 `.docx`、`.xlsx` 和 `.pptx` 文件。保存是
字节级保留的：你未改动的部分会逐字节写回，文档在 Microsoft Office 中照常可用。

</details>

<details>
<summary><b>ThreadnoteOffice 可以离线使用吗？</b></summary>
...
<details>
<summary><b>ThreadnoteOffice 能编辑 PDF 文件吗？</b></summary>
...
<details>
<summary><b>ThreadnoteOffice 能把 PDF 转换为 Word、Excel 或 PowerPoint 吗？</b></summary>
...
可以。除了免密钥的 Genspark 登录，ThreadnoteOffice 还支持自带 Claude、OpenAI、Gemini、
...
<details>
<summary><b>ThreadnoteOffice 能把 HTML 转换为 Word 吗？</b></summary>
...
<details>
<summary><b>我可以从 Claude Code、Codex、Cursor 或脚本中驱动 ThreadnoteOffice 吗？</b></summary>

可以。ThreadnoteOffice 会安装一个 `threadnoteoffice` 命令行，以无界面方式运行同一套引擎：
...
<details>
<summary><b>ThreadnoteOffice 会收集数据吗？</b></summary>

官方打包版本默认会发送有限的使用统计，你可以随时在 设置 → 通用 中关闭上报。
统计数据绝不包含文档内容、文件名、文件路径、账号身份或电子邮件地址。完整的事件
和数据披露见 [ThreadnoteOffice 隐私政策](../../PRIVACY.md)。
...
没有以下开源项目，就不会有 ThreadnoteOffice：
...
ThreadnoteOffice 采用 [Apache License 2.0](../../LICENSE) 许可，仅有一处例外：`ee/`
目录为未来的企业模块预留，受 [ThreadnoteOffice 企业许可证](../../ee/LICENSE) 约束。

ThreadnoteOffice 和 Genspark 的名称与标识是 Mainfunc, Inc. 的商标。Apache-2.0 许可证
