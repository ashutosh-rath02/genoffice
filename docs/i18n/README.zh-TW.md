...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — 開源 AI 辦公套件：Docs、Sheets、Slides、PDF、Markdown 與 HTML，內建 AI 面板" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>官網</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>社群</b></a> ·
  <a href="../../PRIVACY.md"><b>隱私權</b></a>
</p>

ThreadnoteOffice 是一套免費、開源的 Microsoft Office 替代方案，支援 macOS、
...
- **用你自己的金鑰，或完全不用。** 用 Genspark 登入即可省去金鑰設定，
  ...
  的服務端點，也支援本機伺服器。
- **可寫成腳本，也隨時能交給代理。** 應用程式內建 `threadnoteoffice` 命令列，
...
**立即取得：** [macOS](https://github.com/ashutosh-rath02/threadnote)（Apple Silicon 與 Intel）·
[Windows](https://github.com/ashutosh-rath02/threadnote)（x64 與 Arm）·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs 呈現一份雙欄年度報告頁面，含滿版封面圖片、灰底 KPI 表格、頁首與頁尾，縮放 80%，AI 面板收合"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs：一份含橫幅圖片的公司概覽；AI 精簡了概覽段落並插入新的條列區塊，面板提供一鍵回復"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets：AI 新增了一張摘要工作表，用 SUMIF 公式按地區與類別統計營收，並加上直條圖，回報套用了 43 項變更並提供復原按鈕"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets：詢問哪個地區在第二季營收領先，AI 回答歐洲並附上分類明細，同時將使用到的儲存格以連結形式引用，旁邊是訂單工作表"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="ThreadnoteOffice Slides 產生 Aurora Home 投資人簡報的縮時過程：AI 在面板中規劃故事線，投影片依序出現在畫布上，最終簡報以收尾的訴求結束" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides：畫面上是 AI 生成的 Aurora Home 投資人簡報封面投影片，附原始的一行提示詞與 AI 在面板中對已完成內容的摘要"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides：同一份 11 頁投影片的收尾頁設計完成，左側是縮圖列，AI 面板總結了整份簡報的敘事脈絡"></td>
</tr>
<tr>
<td><b>只需一句話</b>——「為 Aurora Home 製作一份 10 頁的投資人簡報……」。
ThreadnoteOffice 會規劃敘事脈絡、研究相關數據，並把每一頁直接生成在畫面上，
成為一份真正的 `.pptx`。</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF：編輯文字模式為頁面上每個文字區塊畫出框線以供就地編輯，同時 AI 面板正在回答一則關於報告的問題並附上頁碼引用"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs 顯示由 Helios 季度報告 PDF 在本機轉換而成的 Word 文件，於第二個分頁開啟，旁邊是原始 PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="ThreadnoteOffice HTML 重新設計 Lumen 到達頁面的縮時過程：面板中一次 Restyle 請求就把深色的 Midnight Studio 頁面變成暖色的 Solar Daybreak 版本，而每個區塊與所有文案都維持不變" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML：以深色 Midnight Studio 風格方向生成的太陽能桌燈登陸頁，畫面顯示即時預覽，AI 面板總結了剛完成的頁面"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML：為自由接案設計師生成的個人儀表板介面，採溫暖亞麻風格，含左側導覽列、襯線問候語與四張指標卡片"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML：以報紙版式生成的電動車市場數據報告，含襯線報頭、一項 1730 萬的頭條數字與一列統計數據"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown：選取一段文字後出現 Ask AI 彈出視窗，內含輸入的指令與建議選項，如「潤飾」「更精簡」「擴寫」「修正語法」，並附「立即送出」與「加入佇列」按鈕"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown 呈現一份上線公告文件，內含表格、Mermaid 流程圖與待辦清單，左側是 AI 面板的起手提示詞"></td>
</tr>
<tr>
...
### 7 · CLI — 讓你的程式開發代理在本機驅動 ThreadnoteOffice

ThreadnoteOffice 內建 `threadnoteoffice` 命令列與一份 agent skill。安裝這份 skill 之後，
Claude Code、Codex、Cursor、Gemini CLI、GitHub Copilot、OpenCode 或 Windsurf
就能透過與應用程式相同的引擎，建立、轉換、讀取與編輯真正的 Office 檔案，
完全不必開啟視窗。

<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides 顯示一份由程式開發代理透過 threadnoteoffice 命令列建立的八頁太陽系簡報：畫布上是封面投影片，左側有八張縮圖，AI 面板處於開啟狀態" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="ThreadnoteOffice 設定的「整合」頁面：threadnoteoffice skill 已安裝到 Claude Code，Codex 與 Cursor 旁邊顯示著「安裝」按鈕"></td>
</tr>
<tr>
<td><b>對代理下一句提示詞</b>——「做一份關於太陽系的八頁簡報。」代理讀取 skill，
寫出一份樣式表、一份大綱與每張投影片各一份的頁面規格，用
<code>threadnoteoffice image</code> 生成兩張照片，再讓 <code>threadnoteoffice slides check</code>
擋下所有溢出或重疊的內容，最後由 <code>threadnoteoffice create</code> 組裝出
<code>.pptx</code>，並以 <code>slides render</code> 交回每張投影片各一張 PNG
供你檢視。</td>
<td><b>在設定 → 整合中一次安裝</b>——ThreadnoteOffice 會列出在這台電腦上找到的
程式開發代理，並把 skill 寫入你勾選的每一個。也可以把 skill 下載成 zip
壓縮檔，或執行 <code>install the bundled Threadnote Office skill from Settings</code>。命令與完整
...
每一個 `threadnoteoffice` 命令同時也是一個 MCP 工具。Claude Code、Claude Desktop、
Cursor 及任何其他 MCP 用戶端都能自行啟動 `threadnoteoffice mcp`，不必安裝 skill，
也不必開啟任何視窗，就能取得 29 個工具以及以資源形式提供的操作參考文件。
應用程式內建的第二個 HTTP 伺服器，還能讓代理在一個可見的編輯器分頁中
建立 Word 文件，讓你即時查看。

<img src="../assets/readme/mcp-deck-motion.webp" alt="Claude Code 透過 threadnoteoffice MCP 伺服器建立一份八頁再生能源投資簡報的縮時畫面：它會搜尋圖表與照片，並用 media 檢查每一張候選圖片，deck_start 寫入樣式表與大綱，deck_page 逐頁新增經過檢查的頁面，deck_build 組裝出 .pptx，slides_render 傳回每一頁的圖片；完成的簡報接著會在 ThreadnoteOffice Slides 中開啟" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides 顯示 Claude Code 透過 threadnoteoffice MCP 伺服器建立的八頁再生能源 2026 簡報：畫布上是帶有風力發電場照片的封面投影片，左側有八張縮圖"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="ThreadnoteOffice 設定的「整合」頁面，MCP 部分：Claude Code 適用的一行 claude mcp add 指令、Cursor、Claude Desktop 與其他 MCP 用戶端適用的 JSON 程式碼區塊，以及下方的本機 HTTP 伺服器選項"></td>
</tr>
<tr>
...
- **可寫成腳本。** `threadnoteoffice` 命令列、agent skill 與 MCP 伺服器讓每一個引擎
...
應用程式能對檔案做的每一件事，`threadnoteoffice` 命令列都能在終端機裡完成：
檢視、轉換、建立、讀取與編輯 Word、Excel、PowerPoint、PDF、Markdown 與
HTML，用的是同一套引擎，且無需介面。它隨 ThreadnoteOffice 一起安裝，不需要
...
| 方式                                                        | 效果                                                                                                                                 |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| 應用程式內的 **設定 → 整合**                                | 列出在這台電腦上找到的代理；按一下就把 skill 寫入你選擇的每一個。當 ThreadnoteOffice 新版本附帶更新的 skill 時，會出現**更新**按鈕。 |
| 同一頁面上的 **下載為 zip**                                 | claude.ai、Claude 桌面版應用程式與其他助理可作為上傳 skill 接受的目錄結構。                                                          |
| `install the bundled Threadnote Office skill from Settings` | 從本儲存庫安裝到任何相容 skills 的代理。                                                                                             |

接著開一個新的對話，請它幫你做一份文件。這份 skill 會教代理何時該使用
`threadnoteoffice`、編輯前如何先讀取檔案，以及如何檢查自己的成果。
...
`threadnoteoffice help` 列出目前的命令集合；完整參考請見
...
`threadnoteoffice` 內部不會發出任何模型呼叫：思考由代理負責，建置與檢查由 CLI
負責，成品則以一份普通的 `.pptx` 在 ThreadnoteOffice 或 PowerPoint 中開啟。
...
| 方式                                       | 內容                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A · `threadnoteoffice mcp`**（建議使用） | 一個由助理自行啟動的 stdio 伺服器，ThreadnoteOffice 不需要處於開啟狀態。每個命令對應一個工具（`info`、`convert`、`create_docx`、`create_xlsx`、`create_pptx`、`create_pdf`、`docs_read` / `docs_apply` / `docs_check`、`sheet_*`、`slides_*`、`render`、`guide`、`search`、`image`、`media`、`open`），再加上分階段的簡報建立流程 `deck_start` → `deck_page` → `deck_build` → `deck_replace`。Ops、spec 與 Markdown 都以內嵌方式傳入，因此沒有檔案系統的用戶端也能正常運作。 |
| **B · 本機 HTTP 伺服器**                   | 執行於 ThreadnoteOffice 應用程式內部，位址為 `http://127.0.0.1:3093/mcp`（Streamable HTTP，並相容舊版 SSE）。它的工具會驅動一個可見的 Word 編輯器分頁：`create_session`、`insert_content`、`replace_blocks`、`apply_ops`、`read_document`、`save_session`，你可以即時看著文件成形。預設為關閉；在同一個設定面板中開啟。                                                                                                                                                      |
...
這裡的 `threadnoteoffice` 就是應用程式內建的那個命令列（在 macOS 上位於
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`；設定面板
會印出你本機安裝的確切路徑）。這個伺服器自帶工作流程說明，並把操作參考
文件以 `threadnoteoffice://guide/*` 資源的形式公開，因此不需要額外的 skill；
skill 與 MCP 伺服器可以共存，由助理自行選擇要用哪一個。雲端功能
（`search`、`image`、`media`）仍會透過 ThreadnoteOffice 中設定的服務商完成；
其餘一切都在本機執行，`THREADNOTE_OFFICE_ALLOWED_ROOTS` 會把每個工具都限制在
你列出的資料夾之內。

上方 Demo 中的再生能源簡報，就是僅接上 `threadnoteoffice` MCP 伺服器時，
...
三十八次呼叫，大約十三分鐘，助理全程沒有碰過終端機：圖表、照片、指南、檢查與渲染結果都是以 MCP 工具結果的形式傳遞。只有 `search` 與 `media` 離開過本機，傳送至 ThreadnoteOffice 中設定的服務供應商。
...
| 平台                                 | 系統需求                                               | 下載                                                                          |
| ------------------------------------ | ------------------------------------------------------ | ----------------------------------------------------------------------------- |
| **macOS** — Apple Silicon（arm64）   | macOS 11 以上                                          | [最新版 `.dmg`（arm64）](https://github.com/ashutosh-rath02/threadnote)       |
| **macOS** — Intel（x64）             | macOS 11 以上                                          | [最新版 `.dmg`（x64）](https://github.com/ashutosh-rath02/threadnote)         |
| **Windows**（x64，一般 PC）          | Windows 10 以上，Intel/AMD                             | [最新版 `-x64.exe` 安裝程式](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** on Arm（ARM64）          | Windows 11 on Arm（Snapdragon X 及同類機型）           | [最新版 `-arm64.exe` 安裝程式](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64，glibc 2.34+（Ubuntu 22.04 或以上）             | [最新版 `.deb`](https://github.com/ashutosh-rath02/threadnote)                |
| **Linux** — Fedora / RHEL / openSUSE | x86_64，glibc 2.34+（Fedora 35+、RHEL 9+、Leap 15.6+） | [最新版 `.rpm`](https://github.com/ashutosh-rath02/threadnote)                |
| **Linux** — 其他發行版               | x86_64，glibc 2.34+，FUSE 2                            | [最新版 `.AppImage`](https://github.com/ashutosh-rath02/threadnote)           |

所有版本皆由 `main` 分支建置，macOS 與 Windows 安裝程式皆有簽署。
較舊版本可在[發行頁面](https://github.com/ashutosh-rath02/threadnote)找到。

<details>
<summary><b>在 Linux 上安裝</b></summary>

deb 套件可用 apt 安裝——會自動處理相依套件，並將 ThreadnoteOffice 加入
應用程式選單：
...
```bash
sudo dnf install ./threadnoteoffice-<version>.x86_64.rpm     # Fedora / RHEL 家族
...
（`cargo` 需在 PATH 中）；執行 `npm run build -w @threadnote/sheets`
會自動完成編譯。每次變更需要通過哪些檢查、PR 如何合併，詳見
[CONTRIBUTING.md](../../CONTRIBUTING.md)。

## 社群

ThreadnoteOffice 正在積極開發中，你的意見回饋會影響它的方向。

- 在 [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues)
  **回報問題或提出功能需求**。
- 到 [GenTeam](https://threadnote.ashutosh123rath.workers.dev) **加入 ThreadnoteOffice 群組聊天**，
  和團隊及其他使用者交流。
- 如果 ThreadnoteOffice 對你有幫助，**幫這個專案按個星星**——這是支持這個
  專案最簡單的方式。

## 常見問題

<details>
<summary><b>ThreadnoteOffice 是免費的嗎？</b></summary>

是的。ThreadnoteOffice 以 Apache-2.0 授權免費開源——應用程式本身沒有試用期，
也沒有付費方案。

</details>

<details>
<summary><b>ThreadnoteOffice 能開啟 Microsoft Word、Excel 與 PowerPoint 檔案嗎？</b></summary>

可以。ThreadnoteOffice 能開啟並儲存原生的 `.docx`、`.xlsx` 與 `.pptx` 檔案。
...
<details>
<summary><b>ThreadnoteOffice 能離線使用嗎？</b></summary>
...
<details>
<summary><b>ThreadnoteOffice 能編輯 PDF 檔案嗎？</b></summary>
...
<details>
<summary><b>ThreadnoteOffice 能把 PDF 轉換成 Word、Excel 或 PowerPoint 嗎？</b></summary>
...
可以。除了免金鑰的 Genspark 登入之外，ThreadnoteOffice 也支援自帶金鑰，
...
<details>
<summary><b>ThreadnoteOffice 能把 HTML 轉換成 Word 嗎？</b></summary>
...
<details>
<summary><b>我可以從 Claude Code、Codex、Cursor 或指令碼驅動 ThreadnoteOffice 嗎？</b></summary>

可以。ThreadnoteOffice 會安裝一個 `threadnoteoffice` 命令列，以無介面的方式執行同一套
...
沒有以下這些開源專案，就不會有 ThreadnoteOffice：
...
ThreadnoteOffice 採用 [Apache License 2.0](../../LICENSE) 授權，唯一例外是
`ee/` 目錄，該目錄保留給未來的企業模組，適用
[ThreadnoteOffice 企業授權](../../ee/LICENSE)。

ThreadnoteOffice 與 Genspark 的名稱與標誌皆為 Mainfunc, Inc. 的商標。
