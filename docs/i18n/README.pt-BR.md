...
<p align="center">
  <a href="https://threadnote.ashutosh123rath.workers.dev/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="ThreadnoteOffice — a suíte de escritório com IA de código aberto: Docs, Sheets, Slides, PDF, Markdown e HTML com um painel de IA integrado" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/ashutosh-rath02/threadnote" alt="Licença: Apache-2.0"></a>
  <a href="https://github.com/ashutosh-rath02/threadnote"><img src="https://img.shields.io/github/v/release/ashutosh-rath02/threadnote" alt="Versão mais recente"></a>
  ...
  <a href="https://github.com/ashutosh-rath02/threadnote/stargazers"><img src="https://img.shields.io/github/stars/ashutosh-rath02/threadnote?style=flat" alt="Estrelas no GitHub"></a>
</p>
...
<p align="center">
  ...
  <a href="https://threadnote.ashutosh123rath.workers.dev/"><b>Site</b></a> ·
  <a href="https://threadnote.ashutosh123rath.workers.dev"><b>Comunidade</b></a> ·
  <a href="../../PRIVACY.md"><b>Privacidade</b></a>
</p>

O ThreadnoteOffice é uma alternativa gratuita e de código aberto ao Microsoft Office
...
- **Automatizável e pronto para agentes.** O app inclui uma linha de comando
  `threadnoteoffice` e um skill para Claude Code, Codex, Cursor, Gemini CLI, GitHub
...
**Baixe:** [macOS](https://github.com/ashutosh-rath02/threadnote) (Apple Silicon e Intel) ·
[Windows](https://github.com/ashutosh-rath02/threadnote) (x64 e Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="ThreadnoteOffice Docs renderizando uma página de relatório anual em duas colunas, com imagem de capa em largura total, tabela de KPIs sombreada, cabeçalho e rodapé, em zoom de 80% com o painel de IA recolhido"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="ThreadnoteOffice Docs: uma visão geral de empresa com uma imagem de banner; a IA condensou a seção Overview e inseriu uma nova seção com marcadores, e o painel oferece uma reversão em um clique"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="ThreadnoteOffice Sheets: a IA adicionou uma planilha Summary com receita por região e categoria usando fórmulas SUMIF, além de um gráfico de colunas, e relata 43 alterações aplicadas com um botão Desfazer"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="ThreadnoteOffice Sheets: ao ser perguntada qual região liderou a receita do Q2, a IA responde Europa com o detalhamento por categoria e cita as células usadas como links, ao lado da planilha Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Timelapse do ThreadnoteOffice Slides gerando o deck de investidores Aurora Home: a IA planeja a narrativa no painel, os slides aparecem no canvas um após o outro, e o deck finalizado termina no pedido de fechamento" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="ThreadnoteOffice Slides: o slide de capa de uma apresentação para investidores da Aurora Home gerada por IA no canvas, com o prompt original de uma linha e o resumo da IA sobre o que construiu no painel"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="ThreadnoteOffice Slides: o slide final projetado da mesma apresentação de 11 slides, com a faixa de miniaturas à esquerda e o painel de IA resumindo a narrativa"></td>
</tr>
<tr>
<td><b>Uma linha de entrada</b> — "Crie uma apresentação de 10 slides para investidores da Aurora Home…". O ThreadnoteOffice planeja a narrativa, pesquisa os números e redige cada slide diretamente no canvas como um `.pptx` real.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="ThreadnoteOffice PDF: o modo Editar texto contorna cada bloco de texto da página para edição no lugar, enquanto o painel de IA responde a uma pergunta sobre o relatório com citações de página"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="ThreadnoteOffice Docs mostrando um documento do Word convertido localmente a partir do PDF de revisão trimestral da Helios, aberto em uma segunda aba ao lado do PDF original"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Timelapse do ThreadnoteOffice HTML reestilizando a landing page Lumen: um pedido de Restyle no painel transforma a página escura Midnight Studio na versão quente Solar Daybreak, mantendo todas as seções e todo o texto no lugar" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="ThreadnoteOffice HTML: uma landing page gerada para uma luminária solar de mesa na direção escura Midnight Studio, mostrada na prévia em tempo real com o painel de IA resumindo a página que acabou de construir"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="ThreadnoteOffice HTML: uma interface de painel pessoal gerada para uma designer freelancer em um estilo quente de linho, com uma barra lateral, saudação serifada e quatro cartões de métricas"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="ThreadnoteOffice HTML: um relatório de dados sobre o mercado de veículos elétricos gerado em estilo jornal, com um cabeçalho serifado, um número de destaque de 17,3 milhões e uma linha de estatísticas"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="ThreadnoteOffice Markdown: um parágrafo selecionado mostra um popover Ask AI com uma instrução digitada e chips de sugestão como Aprimorar, Tornar mais conciso, Expandir e Corrigir gramática, além dos botões Enviar agora e Adicionar à fila"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="ThreadnoteOffice Markdown renderizando um documento de notas de lançamento com uma tabela, um fluxograma Mermaid e uma lista de tarefas, com os prompts iniciais do painel de IA à esquerda"></td>
</tr>
<tr>
...
### 7 · CLI — seu agente de programação comanda o ThreadnoteOffice, na sua máquina

O ThreadnoteOffice inclui uma linha de comando `threadnoteoffice` e um skill de agente.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="ThreadnoteOffice Slides mostrando uma apresentação de oito slides sobre o Sistema Solar que um agente de programação construiu pela linha de comando threadnoteoffice: o slide de capa no canvas, oito miniaturas à esquerda e o painel de IA aberto" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="Configurações do ThreadnoteOffice, página Integrações: o skill threadnoteoffice instalado no Claude Code, com botões Instalar ao lado de Codex e Cursor"></td>
</tr>
<tr>
<td><b>Um prompt para o seu agente</b> — "Crie uma apresentação de oito slides sobre o Sistema Solar." O agente lê o skill, escreve uma folha de estilos, um esboço e uma especificação de página por slide, gera as duas fotos com <code>threadnoteoffice image</code> e deixa o <code>threadnoteoffice slides check</code> rejeitar qualquer coisa que transborde ou se sobreponha antes que o <code>threadnoteoffice create</code> monte o <code>.pptx</code> e o <code>slides render</code> devolva um PNG por slide para conferir.</td>
<td><b>Instale uma vez, em Configurações → Integrações</b> — o ThreadnoteOffice lista os agentes de programação que encontra neste computador e grava o skill em cada um que você escolher. Ou baixe o skill como zip, ou execute <code>install the bundled Threadnote Office skill from Settings</code>. Os comandos e o fluxo de trabalho completo estão em <a href="#command-line-and-agent-skill">Linha de comando e skill de agente</a>.</td>
</tr>
</table>

### 8 · MCP — as mesmas ferramentas através do Model Context Protocol

Todo comando do `threadnoteoffice` também é uma ferramenta MCP. O Claude Code, o
Claude Desktop, o Cursor e qualquer outro cliente MCP podem iniciar o
`threadnoteoffice mcp` por conta própria, sem precisar instalar nenhum skill nem
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Sequência acelerada do Claude Code construindo uma apresentação de investidores de oito slides sobre energia renovável através do servidor MCP do threadnoteoffice: ele busca as figuras e as fotos, verifica cada imagem candidata com o media, o deck_start escreve a folha de estilos e o esboço, o deck_page adiciona uma página verificada por vez, o deck_build monta o .pptx e o slides_render devolve uma imagem de cada slide; a apresentação pronta então abre no ThreadnoteOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="ThreadnoteOffice Slides mostrando a apresentação Renewable Energy 2026 de oito slides que o Claude Code construiu através do servidor MCP do threadnoteoffice: o slide de capa com uma fotografia de um parque eólico no canvas e oito miniaturas à esquerda"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="Configurações do ThreadnoteOffice, página Integrações, parte de MCP: o comando de uma linha claude mcp add para o Claude Code, o bloco JSON para o Cursor, o Claude Desktop e outros clientes MCP, e a opção de servidor HTTP local abaixo"></td>
</tr>
<tr>
...
- **Markdown e HTML também**, com o mesmo painel de IA e exportação local para
  Word.
- **Automatizável.** Uma linha de comando `threadnoteoffice`, um skill de agente e
...
Tudo o que os aplicativos fazem com um arquivo, a linha de comando `threadnoteoffice`
...
interface gráfica. Ela é instalada junto com o ThreadnoteOffice, não precisa de
...
| Como                                                        | O que acontece                                                                                                                                                                                     |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Configurações → Integrações** no app                      | Lista os agentes encontrados neste computador; um clique grava o skill em cada um que você escolher. Um botão **Atualizar** aparece quando uma versão do ThreadnoteOffice traz um skill mais novo. |
...
| `install the bundled Threadnote Office skill from Settings` | Instala a partir deste repositório em qualquer agente compatível com skills.                                                                                                                       |

Depois, abra um novo chat e peça um documento. O skill ensina ao agente
quando recorrer ao `threadnoteoffice`, como ler um arquivo antes de editá-lo e como
...
intocado e volta com um erro orientado. `threadnoteoffice help` lista a superfície
...
Nenhuma chamada a um modelo acontece dentro do `threadnoteoffice`: o agente pensa, a
CLI constrói e verifica, e o resultado abre no ThreadnoteOffice ou no PowerPoint
como um `.pptx` comum.
...
Aqui, `threadnoteoffice` é a CLI que vem dentro do aplicativo (no macOS
`/Applications/ThreadnoteOffice.app/Contents/Resources/cli/threadnoteoffice`; o painel de
...
operações como recursos `threadnoteoffice://guide/*`, então nenhum skill é
...
pelo provedor configurado no ThreadnoteOffice; todo o resto roda localmente, e o
`THREADNOTE_OFFICE_ALLOWED_ROOTS` limita cada ferramenta às pastas que você listar.
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [`.dmg` mais recente (arm64)](https://github.com/ashutosh-rath02/threadnote)          |
| **macOS** — Intel (x64)              | macOS 11+                                             | [`.dmg` mais recente (x64)](https://github.com/ashutosh-rath02/threadnote)            |
| **Windows** (x64, maioria dos PCs)   | Windows 10+, Intel/AMD                                | [Instalador `-x64.exe` mais recente](https://github.com/ashutosh-rath02/threadnote)   |
| **Windows** no Arm (ARM64)           | Windows 11 no Arm (Snapdragon X e similares)          | [Instalador `-arm64.exe` mais recente](https://github.com/ashutosh-rath02/threadnote) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 ou mais recente)    | [`.deb` mais recente](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [`.rpm` mais recente](https://github.com/ashutosh-rath02/threadnote)                  |
| **Linux** — outras distribuições     | x86_64, glibc 2.34+, FUSE 2                           | [`.AppImage` mais recente](https://github.com/ashutosh-rath02/threadnote)             |
...
O deb instala com o apt — ele traz as dependências e adiciona o ThreadnoteOffice
...
xlsx (`cargo` no PATH); `npm run build -w @threadnote/sheets` compila isso
...
O ThreadnoteOffice está em desenvolvimento ativo e o seu feedback ajuda a moldá-lo.

- **Relate um bug ou peça um recurso** em
  [GitHub Issues](https://github.com/ashutosh-rath02/threadnote/issues).
- **Participe do grupo de chat do ThreadnoteOffice** no
  [GenTeam](https://threadnote.ashutosh123rath.workers.dev) para falar com a equipe e outros usuários.
- **Dê uma estrela no repositório** se o ThreadnoteOffice for útil para você — é a
  melhor forma de apoiar o projeto.

## Perguntas frequentes

<details>
<summary><b>O ThreadnoteOffice é gratuito?</b></summary>

Sim. O ThreadnoteOffice é gratuito e de código aberto sob a licença Apache-2.0 —
sem teste gratuito, sem nível pago para os próprios aplicativos.

</details>

<details>
<summary><b>O ThreadnoteOffice pode abrir arquivos do Microsoft Word, Excel e PowerPoint?</b></summary>

Sim. O ThreadnoteOffice abre e salva arquivos nativos `.docx`, `.xlsx` e `.pptx`.
...
<details>
<summary><b>O ThreadnoteOffice funciona offline?</b></summary>
...
<details>
<summary><b>O ThreadnoteOffice pode editar arquivos PDF?</b></summary>
...
<details>
<summary><b>O ThreadnoteOffice pode converter PDF para Word, Excel ou PowerPoint?</b></summary>
...
Sim. Além do login sem chave pelo Genspark, o ThreadnoteOffice permite trazer sua
...
<details>
<summary><b>O ThreadnoteOffice pode converter HTML para Word?</b></summary>
...
<details>
<summary><b>Posso comandar o ThreadnoteOffice a partir do Claude Code, Codex, Cursor ou de um script?</b></summary>

Sim. O ThreadnoteOffice instala uma linha de comando `threadnoteoffice` que executa os
...
<details>
<summary><b>O ThreadnoteOffice coleta algum dado?</b></summary>
...
[ThreadnoteOffice Privacy](../../PRIVACY.md) para a lista completa de eventos e
...
O ThreadnoteOffice não seria possível sem estes projetos de código aberto:
...
O ThreadnoteOffice é licenciado sob a [Apache License 2.0](../../LICENSE), com uma
exceção: o diretório `ee/` é reservado para futuros módulos empresariais e
é coberto pela [ThreadnoteOffice Enterprise License](../../ee/LICENSE).

Os nomes e logotipos ThreadnoteOffice e Genspark são marcas registradas da
