#!/usr/bin/env python3
"""Normalize ThreadnoteOffice Serif KR Latin metrics to Batang.
...
from Word on those documents. ThreadnoteOffice Sans KR already went through the
same treatment for Malgun (normalize-kr-sans-hmtx.py +
scale-kr-sans-latin-ink.py). ThreadnoteOffice Gothic KR is out of scope: it models
...
TARGETS = {
    "ThreadnoteOfficeSerifKR-Regular-subset.woff2": ("batang.ttc", 0),  # Batang
}
