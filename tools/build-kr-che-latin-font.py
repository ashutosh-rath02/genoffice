#!/usr/bin/env python3
"""Build ThreadnoteOffice Che Latin KR: half-width Latin for -Che fixed-pitch faces.
...
ASCII-only face from the ThreadnoteOffice Sans KR outlines (Noto-derived, OFL),
...
SOURCE = "apps/docs/src/renderer/fonts/ThreadnoteOfficeSansKR-Regular-subset.woff2"
DEFAULT_OUT = "apps/docs/src/renderer/fonts/ThreadnoteOfficeCheLatinKR.woff2"
DOTUMCHE = ("/Applications/Microsoft Word.app/Contents/Resources/DFonts/gulim.ttc", 3)
FAMILY = "ThreadnoteOffice Che Latin KR"
PS_NAME = "ThreadnoteOfficeCheLatinKR"
