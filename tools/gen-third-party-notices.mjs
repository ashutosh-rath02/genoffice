...
function bareName(spec) {
  ...
  if (BUILTIN.has(name) || name.startsWith('@threadnote/')) return null
...
let out = `ThreadnoteOffice — Third-Party Software Notices
...
const FONTS = [
  ...
  [
    'ThreadnoteOffice Sans KR (Noto Sans CJK KR derivative)',
    'SIL OFL 1.1',
  ...
  [
    'ThreadnoteOffice Serif KR (Noto Serif CJK KR derivative)',
    'SIL OFL 1.1',
    'Copyright 2017-2024 Adobe (http://www.adobe.com/), Reserved Font Name "Source".\nSubset with modified advance widths and horizontally transformed Noto CJK outlines to match measured\nKorean Office-family metrics; renamed per OFL 1.1. No Microsoft font outlines are included.',
  ],
  [
    'ThreadnoteOffice Che Latin KR (Noto Sans CJK KR derivative)',
    'SIL OFL 1.1',
  ...
  [
    'ThreadnoteOffice Gothic KR (NanumGothic derivative)',
    'SIL OFL 1.1',
    `${GOTHIC_KR_COPYRIGHT}\nSubset with unmodified metrics; renamed per OFL 1.1.`,
  ],
  [
    'ThreadnoteOffice Poppins (Poppins derivative)',
    'SIL OFL 1.1',
    'Copyright 2020 The Poppins Project Authors (https://github.com/itfoundry/Poppins).\nLatin subset with unmodified metrics and advances; renamed.',
  ],
  [
    'ThreadnoteOffice Tamil (Noto Sans Tamil derivative)',
    'SIL OFL 1.1',
