#!/usr/bin/env python3
"""Scale ThreadnoteOffice Sans KR Latin outlines to Malgun Gothic's ink boxes.
...
DEFAULT = "apps/docs/src/renderer/fonts/ThreadnoteOfficeSansKR-Regular-subset.woff2"
