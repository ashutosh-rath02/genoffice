#!/usr/bin/env python3
"""Build ThreadnoteOffice Tamil from upstream Noto Sans Tamil, hmtx-normalized to Latha.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/ThreadnoteOfficeTamil-Regular.woff2"
FAMILY = "ThreadnoteOffice Tamil"
...
def main() -> None:
    ...
    rename(font, FAMILY, "ThreadnoteOfficeTamil-Regular")
    space = cmap.get(0x20)
