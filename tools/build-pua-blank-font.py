#!/usr/bin/env python3
"""Build ThreadnoteOffice PUA Blank: every BMP Private Use codepoint maps to one
blank 1em glyph.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/ThreadnoteOfficePUABlank.woff2"
FAMILY = "ThreadnoteOffice PUA Blank"
UPM = 1000
